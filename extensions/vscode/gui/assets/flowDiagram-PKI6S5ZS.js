import { g as qt } from "./chunk-E2GYISFI.js";
import {
  _ as m,
  n as Ot,
  l as t1,
...
import { g as le } from "./chunk-BFAMUDN2.js";
import { s as ce } from "./chunk-SKB7J2MH.js";
import { c as he } from "./channel.js";
...
` +
        ...
        if (k) {
          const p = r;
          ((p == null ? void 0 : p.animate) !== void 0 &&
            (k.animate = p.animate),
            (p == null ? void 0 : p.animation) !== void 0 &&
              (k.animation = p.animation));
          return;
        }
        let E,
        ...
        if (
          ...
          b.props === void 0
            ? (b.props = c)
            : c !== void 0 && Object.assign(b.props, c),
          r !== void 0)
        ) {
          if (r.shape) {
            if (r.shape !== r.shape.toLowerCase() || r.shape.includes("_"))
              throw new Error(
                `No such shape: ${r.shape}. Shape names should be lowercase.`,
              );
      ...
      addSingleLink(i, a, n, u) {
        ...
        if (
          (A !== void 0 &&
            ...
            c.text.startsWith('"') &&
              c.text.endsWith('"') &&
              (c.text = c.text.substring(1, c.text.length - 1)),
            (c.labelType = A.type)),
          n !== void 0 &&
            ((c.type = n.type),
            (c.stroke = n.stroke),
            (c.length = n.length > 10 ? 10 : n.length)),
          u && !this.edges.some((r) => r.id === u))
        )
          ((c.id = u), (c.isUserDefinedId = !0));
        else {
          const r = this.edges.filter(
...
You have to call mermaid.initialize.`);
        ...
        for (const o of i)
          for (const f of a) {
            const c = o === i[i.length - 1],
              A = f === a[0];
            c && A
              ? this.addSingleLink(o, f, n, u)
              : this.addSingleLink(o, f, n, void 0);
          }
      }
      updateLinkInterpolate(i, a) {
        i.forEach((n) => {
          n === "default"
            ? (this.edges.defaultInterpolate = a)
            : (this.edges[n].interpolate = a);
        });
      }
      updateLink(i, a) {
        i.forEach((n) => {
          ...
          n === "default"
            ...
            : ((this.edges[n].style = a),
              (((o = (u = this.edges[n]) == null ? void 0 : u.style) == null
                ? void 0
                : o.length) ?? 0) > 0 &&
                !(
                  (c = (f = this.edges[n]) == null ? void 0 : f.style) !=
                    null &&
                  c.some((k) => (k == null ? void 0 : k.startsWith("fill")))
                ) &&
                ((r = (A = this.edges[n]) == null ? void 0 : A.style) == null ||
                  r.push("fill:none")));
        });
      }
      addClass(i, a) {
        ...
        i.split(",").forEach((u) => {
          ...
          (o === void 0 &&
            ((o = { id: u, styles: [], textStyles: [] }),
            this.classes.set(u, o)),
            n != null &&
              n.forEach((f) => {
                if (/color/.exec(f)) {
      ...
      setLink(i, a, n) {
        (i.split(",").forEach((u) => {
          ...
          o !== void 0 &&
            ((o.link = it.formatUrl(a, this.config)), (o.linkTarget = n));
        }),
          ...
          S1(i)
            ...
            .on("mouseout", (o) => {
              (a.transition().duration(500).style("opacity", 0),
                S1(o.currentTarget).classed("hover", !1));
            }));
      }
      clear(i = "gen-2") {
        ((this.vertices = new Map()),
      ...
      addSubGraph(i, a, n) {
        ...
        if (
          ((r =
            r ??
            (k.inheritDir
              ? (this.getDirection() ?? b1().direction ?? void 0)
              : void 0)),
          this.version === "gen-1")
        )
      ...
      destructEndLink(i) {
        ...
        switch (a.slice(-1)) {
          case "x":
            ((u = "arrow_cross"),
              a.startsWith("x") && ((u = "double_" + u), (n = n.slice(1))));
            break;
          case ">":
            ((u = "arrow_point"),
              a.startsWith("<") && ((u = "double_" + u), (n = n.slice(1))));
            break;
          case "o":
            ((u = "arrow_circle"),
              a.startsWith("o") && ((u = "double_" + u), (n = n.slice(1))));
            break;
        }
        let o = "normal",
          f = n.length - 1;
        (n.startsWith("=") && (o = "thick"),
          n.startsWith("~") && (o = "invisible"));
        const c = this.countChar(".", n);
        return (
          c && ((o = "dotted"), (f = c)),
          { type: u, stroke: o, length: f }
        );
      }
      destructLink(i, a) {
        ...
        if (a) {
          ...
          return (
            u.type === "double_arrow" && (u.type = "double_arrow_point"),
            (u.length = n.length),
            u
          );
        }
      ...
      getCompiledStyles(i) {
        ...
        for (const n of i) {
          ...
          (u != null &&
            u.styles &&
            (a = [...a, ...(u.styles ?? [])].map((o) => o.trim())),
            u != null &&
              u.textStyles &&
              (a = [...a, ...(u.textStyles ?? [])].map((o) => o.trim())));
        }
        return a;
      }
      getData() {
        ...
        return (
          A.forEach((r, k) => {
            var p;
            const { arrowTypeStart: E, arrowTypeEnd: b } =
                this.destructEdgeType(r.type),
              L = [...(A.defaultStyle ?? [])];
            ...
            const C = {
              ...
              arrowTypeStart:
                (r == null ? void 0 : r.stroke) === "invisible" ||
                (r == null ? void 0 : r.type) === "arrow_open"
                  ? "none"
                  : E,
              arrowTypeEnd:
                (r == null ? void 0 : r.stroke) === "invisible" ||
              ...
              curve:
                ...
                ((p = i.flowchart) == null ? void 0 : p.curve),
            };
            n.push(C);
          }),
  ...
  ge = m(async function (s, i, a, n) {
    ...
    ((r.type = n.type),
      ...
      await Xt(r, k));
    const b =
      ((L = r.config.flowchart) == null ? void 0 : L.diagramPadding) ?? 8;
    (it.insertTitle(
      k,
      "flowchartTitleText",
  ...
  rt = (function () {
    var s = m(function (g1, h, d, g) {
      ...
      J1 = {
        ...
        performAction: m(function (h, d, g, l, _, t, O1) {
          var e = t.length - 1;
          switch (_) {
            case 2:
              this.$ = [];
              break;
            case 3:
              ((!Array.isArray(t[e]) || t[e].length > 0) && t[e - 1].push(t[e]),
                (this.$ = t[e - 1]));
              break;
            case 4:
            case 183:
            ...
            case 45:
              ...
              break;
            case 46:
              (l.addLink(t[e - 2].stmt, t[e], t[e - 1]),
            ...
            case 57:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "doublecircle"));
              break;
            case 58:
            ...
            case 61:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "subroutine"));
              break;
            case 62:
              ((this.$ = t[e - 7]),
                l.addVertex(
            ...
            case 63:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "cylinder"));
              break;
            case 64:
            ...
            case 68:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "trapezoid"));
              break;
            case 69:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "inv_trapezoid"));
              break;
            case 70:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "lean_right"));
              break;
            case 71:
              ((this.$ = t[e - 3]),
                l.addVertex(t[e - 3], t[e - 1], "lean_left"));
              break;
            case 72:
            ...
            case 116:
              ((this.$ = t[e - 3]),
                l.setClickEvent(t[e - 3], t[e - 2]),
                l.setTooltip(t[e - 3], t[e]));
              break;
            case 109:
            ...
            case 110:
              ((this.$ = t[e - 4]),
                l.setClickEvent(t[e - 4], t[e - 3], t[e - 2]),
                l.setTooltip(t[e - 4], t[e]));
              break;
            case 111:
            ...
            case 114:
              ((this.$ = t[e - 6]),
                l.setLink(t[e - 6], t[e - 4], t[e]),
                l.setTooltip(t[e - 6], t[e - 2]));
              break;
            case 117:
            ...
            case 120:
              ((this.$ = t[e - 5]),
                l.setLink(t[e - 5], t[e - 4], t[e]),
                l.setTooltip(t[e - 5], t[e - 2]));
              break;
            case 121:
              ((this.$ = t[e - 4]),
                l.addVertex(t[e - 2], void 0, void 0, t[e]));
              break;
            case 122:
            ...
            case 124:
              ((this.$ = t[e - 8]),
                l.updateLinkInterpolate([t[e - 6]], t[e - 2]),
                l.updateLink([t[e - 6]], t[e]));
              break;
            case 125:
              ((this.$ = t[e - 8]),
                l.updateLinkInterpolate(t[e - 6], t[e - 2]),
        ...
        parse: m(function (h) {
          ...
          for (var Z1 in this.yy)
            Object.prototype.hasOwnProperty.call(this.yy, Z1) &&
              (m1.yy[Z1] = this.yy[Z1]);
          (U.setInput(h, m1.yy),
            (m1.yy.lexer = U),
            (m1.yy.parser = this),
            typeof U.yylloc > "u" && (U.yylloc = {}));
          var $1 = U.yylloc;
          t.push($1);
          ...
          function Gt() {
            ...
            return (
              (X = l.pop() || U.lex() || Nt),
              typeof X != "number" &&
                (X instanceof Array && ((l = X), (X = l.pop())),
                (X = d.symbols_[X] || X)),
              X
            );
          }
              ...
              case 2:
                if (
                  ...
                  (tt = this.performAction.apply(
                    G1,
                    [e, Rt, v, m1.yy, Q[1], _, t].concat(jt),
                  )),
                  typeof tt < "u")
                )
                  return tt;
          ...
          unput: m(function (h) {
            ...
            return (
              (this.yylloc = {
                ...
                last_column: g
                  ? (g.length === l.length ? this.yylloc.first_column : 0) +
                    l[l.length - g.length].length -
                    g[0].length
                  : this.yylloc.first_column - d,
              }),
              this.options.ranges &&
                (this.yylloc.range = [_[0], _[0] + this.yyleng - d]),
...
` +
          ...
          pastInput: m(function () {
            ...
            return (
              (h.length > 20 ? "..." : "") + h.substr(-20).replace(/\n/g, "")
            );
          }, "pastInput"),
...
` +
          ...
          test_match: m(function (h, d) {
            ...
            if (
              (this.options.backtrack_lexer &&
                ...
                this.options.ranges &&
                  (_.yylloc.range = this.yylloc.range.slice(0))),
              (l = h[0].match(/(?:\r\n?|\n).*/g)),
          ...
          next: m(function () {
            ...
            for (var _ = this._currentRules(), t = 0; t < _.length; t++)
              if (
                ((g = this._input.match(this.rules[_[t]])),
                g && (!d || g[0].length > d[0].length))
              ) {
