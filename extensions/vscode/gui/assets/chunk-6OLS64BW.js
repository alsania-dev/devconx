import { g as te } from "./chunk-BFAMUDN2.js";
import { s as ee } from "./chunk-SKB7J2MH.js";
import {
  _ as f,
  l as D,
  c as F,
        ...
        switch (E) {
          ...
          case 26:
            this.$ = {
              stmt: "state",
              id: r[c - 1].trim(),
              note: { position: r[c - 2].trim(), text: r[c].trim() },
            };
            break;
          case 29:
        ...
        unput: f(function (o) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: n
                ? (n.length === g.length ? this.yylloc.first_column : 0) +
                  g[g.length - n.length].length -
                  n[0].length
...
` +
        ...
        next: f(function () {
          ...
          for (var E = this._currentRules(), r = 0; r < E.length; r++)
            if (
              ((n = this._input.match(this.rules[E[r]])),
              n && (!h || n[0].length > h[0].length))
            ) {
    ...
    try {
      (typeof a.db.getLinks == "function"
        ...
        const A =
          typeof k == "string"
            ? k
            : typeof (k == null ? void 0 : k.id) == "string"
              ? k.id
              : "";
        if (!A) {
        ...
        if (
          ($ == null ||
            $.forEach((N) => {
              var P;
              ((P = N.textContent) == null ? void 0 : P.trim()) === A &&
                (x = N);
            }),
          !x)
        ) {
        ...
        (R.replaceChild(u, x),
          u.appendChild(x),
          D.info("🔗 Wrapped node in <a> tag for:", A, m.url));
      });
    } catch (_) {
    ...
    (D.trace("items", t),
      t.forEach((p) => {
        switch (p.stmt) {
          ...
          case Ct:
            {
              (st(e, p.state1, s, a, i, l, d, S),
                st(e, p.state2, s, a, i, l, d, S));
              const T = {
                id: "edge" + M,
                start: p.state1.id,
                end: p.state2.id,
...
function et(e, t, s) {
  ...
  t.cssClasses &&
    ...
    t.cssClasses.split(" ").forEach((i) => {
      const l = s.get(i);
      l &&
        (t.cssCompiledStyles = [...(t.cssCompiledStyles ?? []), ...l.styles]);
    }));
...
function Xt(e) {
  var t;
  return (
    ((t = e == null ? void 0 : e.classes) == null ? void 0 : t.join(" ")) ?? ""
  );
}
...
var st = f((e, t, s, a, i, l, d, S) => {
    ...
    if ((D.info("dataFetcher parsedItem", t, T, m), p !== "root")) {
      ...
      (t.description &&
        (Array.isArray(u.description)
          ...
          : (A = u.description) != null && A.length && u.description.length > 0
            ...
            : ((u.shape = bt), (u.description = t.description)),
        (u.description = W.sanitizeTextOrArray(u.description, k))),
        (($ = u.description) == null ? void 0 : $.length) === 1 &&
          u.shape === kt &&
          (u.type === "group" ? (u.shape = Nt) : (u.shape = bt)),
        !u.type &&
          t.doc &&
          (D.info("Setting cluster for XCX", p, $t(t)),
          (u.type = "group"),
          (u.isGroup = !0),
          (u.dir = $t(t)),
      ...
      if (
        ...
        e &&
          e.id !== "root" &&
          (D.trace("Setting node ", p, " to be child of its parent ", e.id),
          (L.parentId = e.id)),
        (L.centerLabel = !0),
        t.note)
      ) {
    ...
    t.doc &&
      (D.trace("Adding nodes children "), we(t, t.doc, s, a, i, !l, d, S));
  }, "dataFetcher"),
  $e = f(() => {
    (St.clear(), (M = 0));
  }, "reset"),
  ...
  Me =
    ((z = class {
      ...
      docTranslator(t, s, a) {
        if (s.stmt === Ct) {
          (this.docTranslator(t, s.state1, !0),
            this.docTranslator(t, s.state2, !1));
          return;
        }
        if (
          (s.stmt === Q &&
            (s.id === v.START_NODE
              ? ((s.id = t.id + (a ? "_start" : "_end")), (s.start = a))
              : (s.id = s.id.trim())),
      ...
      addState(
        ...
        if (
          (i &&
            (D.info("Setting state description", T, i),
            (Array.isArray(i) ? i : [i]).forEach((m) =>
              this.addDescription(T, m.trim()),
            )),
          l)
        ) {
          const _ = this.currentDocument.states.get(T);
        ...
        (d &&
          (D.info("Setting state classes", T, d),
          (Array.isArray(d) ? d : [d]).forEach((m) =>
            this.setCssClass(T, m.trim()),
          )),
          S &&
            (D.info("Setting state styles", T, S),
            (Array.isArray(S) ? S : [S]).forEach((m) =>
              this.setStyle(T, m.trim()),
            )),
          p &&
            (D.info("Setting state styles", T, S),
            (Array.isArray(p) ? p : [p]).forEach((m) =>
              this.setTextStyle(T, m.trim()),
            )));
      }
      clear(t) {
        ((this.nodes = []),
      ...
      addLink(t, s, a) {
        (this.links.set(t, { url: s, tooltip: a }),
      ...
      endIdIfNeeded(t = "") {
        return t === v.END_NODE
          ? (this.startEndCount++, `${v.END_TYPE}${this.startEndCount}`)
          : t;
      }
      ...
      addDescription(t, s) {
        ...
        (l = a == null ? void 0 : a.descriptions) == null ||
          l.push(W.sanitizeText(i, F()));
      }
      cleanupLabel(t) {
        ...
        s &&
          ...
          s.split(v.STYLECLASS_SEP).forEach((i) => {
            ...
            if (RegExp(v.COLOR_KEYWORD).exec(i)) {
              const S = l
                .replace(v.FILL_KEYWORD, v.BG_FILL)
                .replace(v.COLOR_KEYWORD, v.FILL_KEYWORD);
              a.textStyles.push(S);
            }
            a.styles.push(l);
          });
      ...
      setStyle(t, s) {
        var a, i;
        (i = (a = this.getState(t)) == null ? void 0 : a.styles) == null ||
          i.push(s);
      }
      setTextStyle(t, s) {
        var a, i;
        (i = (a = this.getState(t)) == null ? void 0 : a.textStyles) == null ||
          i.push(s);
      }
      ...
      getDirection() {
        var t;
        return (
          ((t = this.getDirectionStatement()) == null ? void 0 : t.value) ?? de
        );
      }
      setDirection(t) {
