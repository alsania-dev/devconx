...
import { c as dt } from "./cytoscape.esm.js";
import { g as xt } from "./XCircleIcon.js";
var tt = { exports: {} },
  et = { exports: {} },
  rt = { exports: {} },
  Mt = rt.exports,
        ...
        (function (m, y) {
          ...
          return (function (f) {
            ...
            function y(r) {
              ...
              return (
                f[r].call(t.exports, t, t.exports, y),
                (t.l = !0),
                t.exports
              );
            }
            ...
            function (f, m, y) {
              ...
              ((i.prototype.getSource = function () {
                ...
                (i.prototype.getOtherEndInGraph = function (g, a) {
                  for (
                    var v = this.getOtherEnd(g),
                      n = a.getGraphManager().getRoot();
                    ;
                  ) {
                    if (v.getOwner() == a) return v;
                    if (v.getOwner() == n) break;
            ...
            function (f, m, y) {
              ...
              function a(n, c, l, E) {
                (l == null && E == null && (E = c),
                  ...
                  (this.graphManager = n),
                  l != null && c != null
                    ? (this.rect = new e(c.x, c.y, l.width, l.height))
                    : (this.rect = new e()));
              }
              ...
              ((a.prototype.getEdges = function () {
                ...
                (a.prototype.setRect = function (n, c) {
                  ((this.rect.x = n.x),
                    (this.rect.y = n.y),
                    (this.rect.width = c.width),
                    (this.rect.height = c.height));
                }),
                (a.prototype.setCenter = function (n, c) {
                  ((this.rect.x = n - this.rect.width / 2),
                    (this.rect.y = c - this.rect.height / 2));
                }),
                ...
                (a.prototype.getNeighborsList = function () {
                  var n = new Set(),
                    c = this;
                  return (
                    c.edges.forEach(function (l) {
                      if (l.source == c) n.add(l.target);
                      else {
                        if (l.target != c) throw "Incorrect incidency!";
                        n.add(l.source);
                      }
                    }),
                    n
                ...
                (a.prototype.updateBounds = function () {
                  ...
                  if (this.getChild().getNodes().length != 0) {
                    ...
                    if (
                      ...
                      var c = n.getRight() - n.getLeft(),
                        l = n.getBottom() - n.getTop();
                      (this.labelWidth > c &&
                        ((this.rect.x -= (this.labelWidth - c) / 2),
                        this.setWidth(this.labelWidth)),
                        this.labelHeight > l &&
                          (this.labelPos == "center"
                            ? (this.rect.y -= (this.labelHeight - l) / 2)
                            : this.labelPos == "top" &&
                              (this.rect.y -= this.labelHeight - l),
                ...
                (a.prototype.transform = function (n) {
                  ...
                  c > i.WORLD_BOUNDARY
                    ? (c = i.WORLD_BOUNDARY)
                    : c < -i.WORLD_BOUNDARY && (c = -i.WORLD_BOUNDARY);
                  var l = this.rect.y;
                  l > i.WORLD_BOUNDARY
                    ? (l = i.WORLD_BOUNDARY)
                    : l < -i.WORLD_BOUNDARY && (l = -i.WORLD_BOUNDARY);
                  var E = new g(c, l),
              ...
              ((c.prototype.getNodes = function () {
                ...
                (c.prototype.remove = function (E) {
                  ...
                  if (E instanceof o) {
                    ...
                    for (
                      var D = T.edges.slice(), L, O = D.length, d = 0;
                      d < O;
                      d++
                    )
                      ((L = D[d]),
                        L.isInterGraph
                          ? this.graphManager.remove(L)
                          : L.source.owner.remove(L));
                    ...
                    var s = L.source.edges.indexOf(L),
                      h = L.target.edges.indexOf(L);
                    if (!(s > -1 && h > -1))
                      throw "Source and/or target doesn't know this edge!";
                    (L.source.edges.splice(s, 1),
                      L.target != L.source && L.target.edges.splice(h, 1));
                ...
                (c.prototype.updateLeftTop = function () {
                  ...
                  return E == t.MAX_VALUE
                    ? null
                    : (d[0].getParent().paddingLeft != null
                        ? (O = d[0].getParent().paddingLeft)
                        : (O = this.margin),
                      (this.left = T - O),
                      (this.top = E - O),
                      new v(this.left, this.top));
                }),
                (c.prototype.updateBounds = function (E) {
                  ...
                  (T == t.MAX_VALUE &&
                    ...
                    p[0].getParent().paddingLeft != null
                      ? (u = p[0].getParent().paddingLeft)
                      : (u = this.margin),
                    (this.left = x.x - u),
                    (this.right = x.x + x.width + u),
                    (this.top = x.y - u),
                    (this.bottom = x.y + x.height + u));
                }),
                ...
                (c.prototype.calcEstimatedSize = function () {
                  for (
                    var E = 0, T = this.nodes, D = T.length, L = 0;
                    L < D;
                    L++
                  ) {
                    var O = T[L];
              ...
              ((e.prototype.addRoot = function () {
                ...
                (e.prototype.add = function (i, o, g, a, v) {
                  if (g == null && a == null && v == null) {
                    ...
                    if (n == c) return ((g.isInterGraph = !1), n.add(g, a, v));
                    if (
                      ((g.isInterGraph = !0),
                      (g.source = a),
                      (g.target = v),
                    ...
                    if (
                      (this.edges.push(g),
                      !(g.source != null && g.target != null))
                    )
                      throw "Edge source and/or target is null!";
                    if (
                      !(
                        g.source.edges.indexOf(g) == -1 &&
                        g.target.edges.indexOf(g) == -1
                      )
                    )
                ...
                (e.prototype.remove = function (i) {
                  if (i instanceof r) {
                    ...
                    if (
                      !(
                        o == this.rootGraph ||
                        (o.parent != null && o.parent.graphManager == this)
                      )
                    )
                    ...
                    var l;
                    v = c.length;
                    for (var n = 0; n < v; n++) ((l = c[n]), o.remove(l));
                ...
                (e.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var i = [], o = this.getGraphs(), g = o.length, a = 0;
                      a < g;
                      a++
                    )
                  ...
                  for (
                    ...
                    for (a = o.getOwner(); i.lca == null; ) {
                      for (
                        ...
                        if (v == this.rootGraph) break;
                        if (i.lca != null) throw "assert failed";
                        ((i.targetInLca = v.getParent()),
                          (v = i.targetInLca.getOwner()));
                      }
                      if (a == this.rootGraph) break;
                      i.lca == null &&
                        ((i.sourceInLca = a.getParent()),
                        (a = i.sourceInLca.getOwner()));
                    }
                    if (i.lca == null) throw "assert failed";
                  }
                }),
                ...
                (e.prototype.calcInclusionTreeDepths = function (i, o) {
                  ...
                  for (var g, a = i.getNodes(), v = a.length, n = 0; n < v; n++)
                    ((g = a[n]),
                      ...
                      g.child != null &&
                        this.calcInclusionTreeDepths(g.child, o + 1));
                }),
                (e.prototype.includesInvalidEdge = function () {
                  for (var i, o = this.edges.length, g = 0; g < o; g++)
                    if (
                      ((i = this.edges[g]),
                      this.isOneAncestorOfOther(i.source, i.target))
                    )
                      return !0;
                  return !1;
                }),
            ...
            function (f, m, y) {
              ...
              ((t.MAX_ITERATIONS = 2500),
                ...
                (t.MAX_NODE_DISPLACEMENT =
                  t.MAX_NODE_DISPLACEMENT_INCREMENTAL * 3),
            ...
            function (f, m, y) {
              ...
              ((t.calcSeparationAmount = function (e, i, o, g) {
                ...
                (this.decideDirectionsForOverlappingNodes(e, i, a),
                  (o[0] =
                    Math.min(e.getRight(), i.getRight()) - Math.max(e.x, i.x)),
                  (o[1] =
                    Math.min(e.getBottom(), i.getBottom()) -
                    Math.max(e.y, i.y)),
                  e.getX() <= i.getX() && e.getRight() >= i.getRight()
                    ? (o[0] += Math.min(
                        i.getX() - e.getX(),
                        e.getRight() - i.getRight(),
                      ))
                    : i.getX() <= e.getX() &&
                ...
                var v = Math.abs(
                  (i.getCenterY() - e.getCenterY()) /
                    (i.getCenterX() - e.getCenterX()),
                );
                i.getCenterY() === e.getCenterY() &&
                  i.getCenterX() === e.getCenterX() &&
                  (v = 1);
                ...
                (t.getIntersection2 = function (e, i, o) {
                  ...
                  if (g === v) {
                    ...
                    if (
                      (g > v
                        ? a > n
                          ? ((G = this.getCardinalDirection(U, M, 4)),
                            (F = this.getCardinalDirection(X, M, 2)))
                          : ((G = this.getCardinalDirection(-U, M, 3)),
                            (F = this.getCardinalDirection(-X, M, 1)))
                        : a > n
                          ? ((G = this.getCardinalDirection(-U, M, 1)),
                            (F = this.getCardinalDirection(-X, M, 3)))
                          : ((G = this.getCardinalDirection(U, M, 2)),
                            (F = this.getCardinalDirection(X, M, 4))),
                      !x)
                    )
                      switch (G) {
                        case 1:
                ...
                (t.angleOfVector = function (e, i, o, g) {
                  ...
                  return (
                    e !== o
                      ? ((a = Math.atan((g - i) / (o - e))),
                        o < e ? (a += Math.PI) : g < i && (a += this.TWO_PI))
                      : g < i
            ...
            function (f, m, y) {
              ...
              var e = function (v) {
                ...
                i = function (v, n, c, l) {
                  return (
                    v !== null ? (v.next = n) : (l.head = n),
                    c !== null ? (c.prev = n) : (l.tail = n),
                    (n.prev = v),
                    (n.next = c),
                    l.length++,
                    n
                ...
                o = function (v, n) {
                  var c = v.prev,
                    l = v.next;
                  return (
                    c !== null ? (c.next = l) : (n.head = l),
                    l !== null ? (l.prev = c) : (n.tail = c),
                    (v.prev = v.next = null),
                    n.length--,
                    v
                  );
              ...
              ((t.lastID = 0),
                (t.createID = function (e) {
                  return t.isPrimitive(e)
                    ? e
                    : (e.uniqueID != null ||
                        ((e.uniqueID = t.getString()), t.lastID++),
                      e.uniqueID);
                }),
            ...
            function (f, m, y) {
              ...
              ((c.RANDOM_SEED = 1),
                ...
                (c.prototype.runLayout = function () {
                  ...
                  var l;
                  return (
                    this.checkLayoutSuccess() ? (l = !1) : (l = this.layout()),
                    t.ANIMATE === "during"
                      ? !1
                      : (l && (this.isSubLayout || this.doPostLayout()),
                ...
                (c.prototype.update2 = function () {
                  if (
                    ...
                    for (
                      var l = this.graphManager.getAllEdges(), E = 0;
                      E < l.length;
                      E++
                    )
                      l[E];
                    for (
                      var T = this.graphManager.getRoot().getNodes(), E = 0;
                      E < T.length;
                      E++
                    )
                      T[E];
                ...
                (c.prototype.initParameters = function () {
                  (this.isSubLayout ||
                    ...
                    (this.incremental = t.DEFAULT_INCREMENTAL),
                    (this.createBendsAsNeeded =
                      t.DEFAULT_CREATE_BENDS_AS_NEEDED),
                    (this.uniformLeafNodeSizes =
                      t.DEFAULT_UNIFORM_LEAF_NODE_SIZES)),
                    this.animationDuringLayout &&
                ...
                (c.prototype.transform = function (l) {
                  if (l == null) this.transform(new a(0, 0));
                  else {
                    var E = new v(),
                ...
                (c.prototype.getFlatForest = function () {
                  for (
                    var l = [],
                      E = !0,
                      T = this.graphManager.getRoot().getNodes(),
                      D = !0,
                      L = 0;
                    L < T.length;
                    L++
                ...
                (c.prototype.createDummyNodesForBendpoints = function (l) {
                  for (
                    var E = [],
                      T = l.source,
                      D = this.graphManager.calcLowestCommonAncestor(
                        l.source,
                        l.target,
                      ),
                      L = 0;
                    L < l.bendpoints.length;
                    L++
                  ) {
                  ...
                  var d = this.newEdge(null);
                  return (
                    this.graphManager.add(d, T, l.target),
                    this.edgeToDummyNodes.set(l, E),
                    l.isInterGraph()
                      ? this.graphManager.remove(l)
                      : D.remove(l),
                    E
                ...
                (c.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  ((l = l.concat(this.graphManager.getAllEdges())),
                    (l = [].concat(r(this.edgeToDummyNodes.keys())).concat(l)));
                  for (var E = 0; E < l.length; E++) {
                    var T = l[E];
                    if (T.bendpoints.length > 0) {
                      for (
                        var D = this.edgeToDummyNodes.get(T), L = 0;
                        L < D.length;
                        L++
                      ) {
                        var O = D[L],
                          d = new a(O.getCenterX(), O.getCenterY()),
                ...
                (t.prototype.transformX = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i =
                        this.ldeviceOrgX +
                        ((e - this.lworldOrgX) * this.ldeviceExtX) / o),
                    i
                  );
                }),
                (t.prototype.transformY = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i =
                        this.ldeviceOrgY +
                        ((e - this.lworldOrgY) * this.ldeviceExtY) / o),
                    i
                  );
                }),
                (t.prototype.inverseTransformX = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i =
                        this.lworldOrgX +
                        ((e - this.ldeviceOrgX) * this.lworldExtX) / o),
                    i
                  );
                }),
                (t.prototype.inverseTransformY = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i =
                        this.lworldOrgY +
                        ((e - this.ldeviceOrgY) * this.lworldExtY) / o),
                    i
                  );
                }),
              ...
              ((a.prototype.initParameters = function () {
                  ...
                  for (
                    ...
                    ((n = L[O]),
                      ...
                      n.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation &&
                          (n.idealLength += T + D - 2 * i.SIMPLE_NODE_SIZE),
                        (c = n.getLca().getInclusionTreeDepth()),
                        (n.idealLength +=
                          e.DEFAULT_EDGE_LENGTH *
                          e.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (l.getInclusionTreeDepth() +
                            E.getInclusionTreeDepth() -
                            2 * c))));
                }),
                ...
                (a.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      ...
                      ((T = L[l]),
                        this.calculateRepulsionForceOfANode(T, O, n, c),
                        O.add(T));
                  else
                    for (l = 0; l < L.length; l++)
                      for (T = L[l], E = l + 1; E < L.length; E++)
                        ((D = L[E]),
                          T.getOwner() == D.getOwner() &&
                            this.calcRepulsionForce(T, D));
                }),
                (a.prototype.calcGravitationalForces = function () {
                  for (
                    var n, c = this.getAllNodesToApplyGravitation(), l = 0;
                    l < c.length;
                    l++
                  )
                ...
                (a.prototype.calcRepulsionForce = function (n, c) {
                  var l = n.getRect(),
                    ...
                    u;
                  if (l.intersects(E)) {
                    (o.calcSeparationAmount(l, E, T, e.DEFAULT_EDGE_LENGTH / 2),
                      (h = 2 * T[0]),
                      (u = 2 * T[1]));
                    var p =
                      (n.noOfChildren * c.noOfChildren) /
                      (n.noOfChildren + c.noOfChildren);
                    ((n.repulsionForceX -= p * h),
                      (n.repulsionForceY -= p * u),
                      (c.repulsionForceX += p * h),
                      (c.repulsionForceY += p * u));
                  } else
                    (this.uniformLeafNodeSizes &&
                    n.getChild() == null &&
                    c.getChild() == null
                      ? ((L = E.getCenterX() - l.getCenterX()),
                        (O = E.getCenterY() - l.getCenterY()))
                      : (o.getIntersection(l, E, D),
                        (L = D[2] - D[0]),
                        (O = D[3] - D[1])),
                      Math.abs(L) < e.MIN_REPULSION_DIST &&
                        (L = g.sign(L) * e.MIN_REPULSION_DIST),
                      Math.abs(O) < e.MIN_REPULSION_DIST &&
                        (O = g.sign(O) * e.MIN_REPULSION_DIST),
                      (d = L * L + O * O),
                      (N = Math.sqrt(d)),
                      (s =
                ...
                (a.prototype.calcGravitationalForce = function (n) {
                  var c, l, E, T, D, L, O, d;
                  ((c = n.getOwner()),
                    (l = (c.getRight() + c.getLeft()) / 2),
                    (E = (c.getTop() + c.getBottom()) / 2),
                    (T = n.getCenterX() - l),
                    (D = n.getCenterY() - E),
                    (L = Math.abs(T) + n.getWidth() / 2),
                    (O = Math.abs(D) + n.getHeight() / 2),
                    n.getOwner() == this.graphManager.getRoot()
                      ? ((d = c.getEstimatedSize() * this.gravityRangeFactor),
                        (L > d || O > d) &&
                ...
                (a.prototype.calcNoOfChildrenForAllNodes = function () {
                  for (
                    var n, c = this.graphManager.getAllNodes(), l = 0;
                    l < c.length;
                    l++
                  )
                ...
                (a.prototype.calcGrid = function (n) {
                  ...
                  ((c = parseInt(
                    Math.ceil(
                      (n.getRight() - n.getLeft()) / this.repulsionRange,
                    ),
                  )),
                    (l = parseInt(
                      Math.ceil(
                        (n.getBottom() - n.getTop()) / this.repulsionRange,
                      ),
                    )));
                  for (var E = new Array(c), T = 0; T < c; T++)
                    E[T] = new Array(l);
                  for (var T = 0; T < c; T++)
                    for (var D = 0; D < l; D++) E[T][D] = new Array();
                  return E;
                }),
                (a.prototype.addNodeToGrid = function (n, c, l) {
                  var E = 0,
                    ...
                    L = 0;
                  ((E = parseInt(
                    Math.floor((n.getRect().x - c) / this.repulsionRange),
                  )),
                    (T = parseInt(
                      Math.floor(
                        (n.getRect().width + n.getRect().x - c) /
                          this.repulsionRange,
                      ),
                    )),
                    (D = parseInt(
                      Math.floor((n.getRect().y - l) / this.repulsionRange),
                    )),
                    (L = parseInt(
                      Math.floor(
                        (n.getRect().height + n.getRect().y - l) /
                          this.repulsionRange,
                      ),
                    )));
                  for (var O = E; O <= T; O++)
                    for (var d = D; d <= L; d++)
                      (this.grid[O][d].push(n),
                        n.setGridCoordinates(E, T, D, L));
                }),
                ...
                (a.prototype.calculateRepulsionForceOfANode = function (
                  n,
                  c,
                  l,
                  E,
                  ...
                  if (
                    ...
                    for (
                      var D, L = this.grid, O = n.startX - 1;
                      O < n.finishX + 2;
                      O++
                    )
                      for (var d = n.startY - 1; d < n.finishY + 2; d++)
                        if (
                          !(O < 0 || d < 0 || O >= L.length || d >= L[0].length)
                        ) {
                          for (var N = 0; N < L[O][d].length; N++)
                            if (
                              ((D = L[O][d][N]),
                              !(n.getOwner() != D.getOwner() || n == D) &&
                                !c.has(D) &&
                                !T.has(D))
                            ) {
                              var s =
                                  Math.abs(n.getCenterX() - D.getCenterX()) -
                                  (n.getWidth() / 2 + D.getWidth() / 2),
                                h =
                                  Math.abs(n.getCenterY() - D.getCenterY()) -
                                  (n.getHeight() / 2 + D.getHeight() / 2);
                              s <= this.repulsionRange &&
            ...
            function (f, m, y) {
              ...
              function e(o, g, a) {
                (r.call(this, o, g, a),
                  (this.idealLength = t.DEFAULT_EDGE_LENGTH));
              }
            ...
            function (f, m, y) {
              ...
              ((t.prototype.add = function (e) {
                ...
                (t.prototype.addAllTo = function (e) {
                  for (
                    var i = Object.keys(this.set), o = i.length, g = 0;
                    g < o;
                    g++
                  )
                    e.push(this.set[i[g]]);
              ...
              var e = y(11),
                i = (function () {
                  function o(g, a) {
                    ...
                    var v = void 0;
                    (g instanceof e ? (v = g.size()) : (v = g.length),
                      this._quicksort(g, 0, v - 1));
                  }
                  return (
                    r(o, [
                      {
                        ...
                        value: function (a, v, n) {
                          if (v < n) {
                            ...
                            (this._quicksort(a, v, c),
                              this._quicksort(a, c + 1, n));
                          }
                        },
                      },
                      {
              ...
              var e = (function () {
                function i(o, g) {
                  ...
                  for (var c = 0; c < this.iMax; c++) {
                    ...
                    for (var l = 0; l < this.jMax; l++) this.grid[c][l] = 0;
                  }
                    ...
                    },
                    {
                      ...
                      value: function () {
                        for (var g = 1; g < this.jMax; g++)
                          ((this.grid[0][g] =
                            this.grid[0][g - 1] + this.gap_penalty),
                            (this.tracebackGrid[0][g] = [!1, !1, !0]));
                        for (var a = 1; a < this.iMax; a++)
                          ((this.grid[a][0] =
                            this.grid[a - 1][0] + this.gap_penalty),
                            (this.tracebackGrid[a][0] = [!1, !0, !1]));
                        for (var v = 1; v < this.iMax; v++)
                          for (var n = 1; n < this.jMax; n++) {
                            var c = void 0;
                            this.sequence1[v - 1] === this.sequence2[n - 1]
                              ? (c = this.grid[v - 1][n - 1] + this.match_score)
                              : (c =
                                  this.grid[v - 1][n - 1] +
                                  this.mismatch_penalty);
                            var l = this.grid[v - 1][n] + this.gap_penalty,
                              E = this.grid[v][n - 1] + this.gap_penalty,
                              T = [c, l, E],
                              D = this.arrayAllMaxIndexes(T);
                            ((this.grid[v][n] = T[D[0]]),
                              (this.tracebackGrid[v][n] = [
                                D.includes(0),
                                D.includes(1),
                                D.includes(2),
                              ]));
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          var a = g[0],
                            v = this.tracebackGrid[a.pos[0]][a.pos[1]];
                          (v[0] &&
                            g.push({
        ...
        (function (m, y) {
          ...
          return (function (m) {
            ...
            function r(t) {
              ...
              return (
                m[t].call(e.exports, e, e.exports, r),
                (e.l = !0),
                e.exports
              );
            }
              ...
              ((i.prototype.move = function () {
                ...
                ((this.displacementX =
                  ...
                  Math.abs(this.displacementX) >
                    g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementX =
                      g.coolingFactor *
                      g.maxNodeDisplacement *
                ...
                (i.prototype.propogateDisplacementToChildren = function (g, a) {
                  for (
                    var v = this.getChild().getNodes(), n, c = 0;
                    c < v.length;
                    c++
                  )
                    ((n = v[c]),
            ...
            function (m, y, r) {
              ...
              ((d.prototype.newGraphManager = function () {
                ...
                (d.prototype.initParameters = function () {
                  (t.prototype.initParameters.call(this, arguments),
                    this.isSubLayout ||
                      ...
                      (this.springConstant = v.DEFAULT_SPRING_STRENGTH),
                      (this.repulsionConstant = v.DEFAULT_REPULSION_STRENGTH),
                      (this.gravityConstant = v.DEFAULT_GRAVITY_STRENGTH),
                      (this.compoundGravityConstant =
                        v.DEFAULT_COMPOUND_GRAVITY_STRENGTH),
                      (this.gravityRangeFactor =
                        v.DEFAULT_GRAVITY_RANGE_FACTOR),
                      (this.compoundGravityRangeFactor =
                        v.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR),
                      (this.prunedNodesAll = []),
                      ...
                      (this.maxCoolingCycle =
                        this.maxIterations / v.CONVERGENCE_CHECK_PERIOD),
                      (this.finalTemperature =
                        v.CONVERGENCE_CHECK_PERIOD / this.maxIterations),
                ...
                (d.prototype.classicLayout = function () {
                  if (
                    ...
                    if (a.TREE_REDUCTION_ON_INCREMENTAL) {
                      ...
                      var h = new Set(this.getAllNodes()),
                        u = this.nodesWithGravity.filter(function (C) {
                          return h.has(C);
                        });
                    ...
                    if (s.length > 0) this.positionNodesRadially(s);
                      ...
                      (this.reduceTrees(),
                        this.graphManager.resetAllNodesToApplyGravitation());
                      var h = new Set(this.getAllNodes()),
                        u = this.nodesWithGravity.filter(function (p) {
                          return h.has(p);
                        });
                      (this.graphManager.setAllNodesToApplyGravitation(u),
                        this.positionNodesRandomly());
                ...
                (d.prototype.tick = function () {
                  ...
                  if (
                    this.totalIterations % v.CONVERGENCE_CHECK_PERIOD == 0 &&
                    !this.isTreeGrowing &&
                    !this.isGrowthFinished
                  ) {
                    if (this.isConverged())
                    ...
                    if (this.growTreeIterations % 10 == 0)
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        var s = new Set(this.getAllNodes()),
                          h = this.nodesWithGravity.filter(function (A) {
                            return s.has(A);
                          });
                        (this.graphManager.setAllNodesToApplyGravitation(h),
                          this.graphManager.updateBounds(),
                          this.updateGrid(),
                          (this.coolingFactor =
                  ...
                  var u = !this.isTreeGrowing && !this.isGrowthFinished,
                    p =
                ...
                (d.prototype.getPositionsData = function () {
                  for (
                    var s = this.graphManager.getAllNodes(), h = {}, u = 0;
                    u < s.length;
                    u++
                  ) {
                    var p = s[u].rect,
                ...
                (d.prototype.runSpringEmbedder = function () {
                  ...
                  var s = !1;
                  if (v.ANIMATE === "during") this.emit("layoutstarted");
                  else {
                    for (; !s; ) s = this.tick();
                    this.graphManager.updateBounds();
                  }
                ...
                (d.prototype.calculateNodesToApplyGravitationTo = function () {
                  var s = [],
                    h,
                    u = this.graphManager.getGraphs(),
                    p = u.length,
                    A;
                  for (A = 0; A < p; A++)
                    ((h = u[A]),
                      h.updateConnected(),
                      h.isConnected || (s = s.concat(h.getNodes())));
                  return s;
                }),
                  ...
                  for (u = 0; u < s.length; u++) {
                    ...
                    if (!h.has(p)) {
                      ...
                      if (A == C)
                        ...
                        var R = [];
                        if (
                          ((R = R.concat(A.getEdgeListToNode(C))),
                          (R = R.concat(C.getEdgeListToNode(A))),
                          !h.has(R[0]))
                        ) {
                          if (R.length > 1) {
                            var x;
                            for (x = 0; x < R.length; x++) {
                              var _ = R[x];
                              (_.getBendpoints().push(new l()),
                                this.createDummyNodesForBendpoints(_));
                            }
                          }
                    ...
                    if (h.size == s.length) break;
                  }
                }),
                (d.prototype.positionNodesRadially = function (s) {
                  for (
                    var h = new c(0, 0),
                      u = Math.ceil(Math.sqrt(s.length)),
                      p = 0,
                      A = 0,
                      C = 0,
                      R = new l(0, 0),
                    ...
                    x % u == 0 &&
                      ((C = 0),
                      (A = p),
                      x != 0 && (A += a.DEFAULT_COMPONENT_SEPERATION),
                      (p = 0));
                    var _ = s[x],
                      U = E.findCenterOfTree(_);
                    ((h.x = C),
                      (h.y = A),
                      (R = d.radialLayout(_, U, h)),
                      R.y > p && (p = Math.floor(R.y)),
                      (C = Math.floor(R.x + a.DEFAULT_COMPONENT_SEPERATION)));
                  }
                  this.transform(
                    new l(
                      n.WORLD_CENTER_X - R.x / 2,
                      n.WORLD_CENTER_Y - R.y / 2,
                    ),
                  );
                }),
                (d.radialLayout = function (s, h, u) {
                  var p = Math.max(
                    this.maxDiagonalInTree(s),
                    a.DEFAULT_RADIAL_SEPARATION,
                  );
                ...
                (d.branchRadialLayout = function (s, h, u, p, A, C) {
                  ...
                  h != null && G--;
                  for (
                    var F = 0, b = M.length, Y, k = s.getEdgesBetween(h);
                    k.length > 1;
                  ) {
                    var H = k[0];
                    k.splice(0, 1);
                ...
                (d.prototype.groupZeroDegreeMembers = function () {
                  ...
                  for (
                    var u = [], p = this.graphManager.getAllNodes(), A = 0;
                    A < p.length;
                    A++
                  ) {
                    var C = p[A],
                      R = C.getParent();
                    this.getNodeDegreeWithChildren(C) === 0 &&
                      (R.id == null || !this.getToBeTiled(R)) &&
                      u.push(C);
                  }
                  ...
                  Object.keys(h).forEach(function (_) {
                    if (h[_].length > 1) {
                      ...
                      ((M.id = U),
                        ...
                        (s.idToDummyNode[U] = M));
                      var G = s.getGraphManager().add(s.newGraph(), M),
                        F = X.getChild();
                      F.add(M);
                ...
                (d.prototype.clearCompounds = function () {
                  ...
                  for (var u = 0; u < this.compoundOrder.length; u++)
                    ((h[this.compoundOrder[u].id] = this.compoundOrder[u]),
                      (s[this.compoundOrder[u].id] = [].concat(
                        this.compoundOrder[u].getChild().getNodes(),
                      )),
                      this.graphManager.remove(
                        this.compoundOrder[u].getChild(),
                      ),
                      (this.compoundOrder[u].child = null));
                  (this.graphManager.resetAllNodes(),
                    this.tileCompoundMembers(s, h));
                }),
                (d.prototype.clearZeroDegreeMembers = function () {
                  var s = this,
                    h = (this.tiledZeroDegreePack = []);
                ...
                (d.prototype.getToBeTiled = function (s) {
                  ...
                  var u = s.getChild();
                  if (u == null) return ((this.toBeTiled[h] = !1), !1);
                ...
                (d.prototype.getNodeDegreeWithChildren = function (s) {
                  ...
                  if (s.getChild() == null) return h;
                  for (
                    var u = s.getChild().getNodes(), p = 0;
                    p < u.length;
                    p++
                  ) {
                    var A = u[p];
                ...
                (d.prototype.fillCompexOrderByDFS = function (s) {
                  for (var h = 0; h < s.length; h++) {
                    var u = s[h];
                    (u.getChild() != null &&
                      this.fillCompexOrderByDFS(u.getChild().getNodes()),
                      this.getToBeTiled(u) && this.compoundOrder.push(u));
                  }
                }),
                (d.prototype.adjustLocations = function (s, h, u, p, A) {
                  ...
                  for (var C = h, R = 0; R < s.rows.length; R++) {
                    ...
                    for (var _ = 0, U = 0; U < x.length; U++) {
                      ...
                      ((X.rect.x = h),
                        (X.rect.y = u),
                        (h += X.rect.width + s.horizontalPadding),
                ...
                (d.prototype.tileCompoundMembers = function (s, h) {
                  ...
                  ((this.tiledMemberPack = []),
                    Object.keys(s).forEach(function (p) {
                      var A = h[p];
                      ((u.tiledMemberPack[p] = u.tileNodes(
                        s[p],
                        A.paddingLeft + A.paddingRight,
                      )),
                        (A.rect.width = u.tiledMemberPack[p].width),
                        (A.rect.height = u.tiledMemberPack[p].height));
                    }));
                }),
                (d.prototype.tileNodes = function (s, h) {
                  var u = a.TILING_PADDING_VERTICAL,
                  ...
                  for (var C = 0; C < s.length; C++) {
                    var R = s[C];
                    (A.rows.length == 0
                      ? this.insertNodeToRow(A, R, 0, h)
                      : this.canAddHorizontal(A, R.rect.width, R.rect.height)
                        ? this.insertNodeToRow(
                            A,
                            R,
                            this.getShortestRowIndex(A),
                            h,
                          )
                        : this.insertNodeToRow(A, R, A.rows.length, h),
                ...
                (d.prototype.insertNodeToRow = function (s, h, u, p) {
                  ...
                  (s.rows[u].length > 0 && (R += s.horizontalPadding),
                    (s.rowWidth[u] = R),
                    s.width < R && (s.width = R));
                  var x = h.rect.height;
                ...
                (d.prototype.getShortestRowIndex = function (s) {
                  for (
                    var h = -1, u = Number.MAX_VALUE, p = 0;
                    p < s.rows.length;
                    p++
                  )
                ...
                (d.prototype.getLongestRowIndex = function (s) {
                  for (
                    var h = -1, u = Number.MIN_VALUE, p = 0;
                    p < s.rows.length;
                    p++
                  )
                    s.rowWidth[p] > u && ((h = p), (u = s.rowWidth[p]));
                ...
                (d.prototype.canAddHorizontal = function (s, h, u) {
                  ...
                  s.rowHeight[p] < u &&
                    p > 0 &&
                    (C = u + s.verticalPadding - s.rowHeight[p]);
                  var R;
                  (s.width - A >= h + s.horizontalPadding
                    ? (R = (s.height + C) / (A + h + s.horizontalPadding))
                    : (R = (s.height + C) / s.width),
                    (C = u + s.verticalPadding));
                  var x;
                  return (
                    s.width < h
                      ? (x = (s.height + C) / h)
                      : (x = (s.height + C) / s.width),
                    x < 1 && (x = 1 / x),
                    R < 1 && (R = 1 / R),
                    R < x
                  );
                ...
                (d.prototype.shiftToLastRow = function (s) {
                  var h = this.getLongestRowIndex(s),
                    u = s.rowWidth.length - 1,
                    p = s.rows[h],
                    A = p[p.length - 1],
                  ...
                  if (s.width - s.rowWidth[u] > C && h != u) {
                    (p.splice(-1, 1),
                      s.rows[u].push(A),
                      (s.rowWidth[h] = s.rowWidth[h] - C),
                      (s.rowWidth[u] = s.rowWidth[u] + C),
                    ...
                    ((s.rowHeight[h] = R),
                      s.rowHeight[u] < A.height + s.verticalPadding &&
                        (s.rowHeight[u] = A.height + s.verticalPadding));
                ...
                (d.prototype.reduceTrees = function () {
                  for (var s = [], h = !0, u; h; ) {
                    ...
                    for (var C = 0; C < p.length; C++)
                      ((u = p[C]),
                        u.getEdges().length == 1 &&
                          !u.getEdges()[0].isInterGraph &&
                          u.getChild() == null &&
                          (A.push([u, u.getEdges()[0], u.getOwner()]),
                          (h = !0)));
                    if (h == !0) {
                      for (var R = [], x = 0; x < A.length; x++)
                        A[x][0].getEdges().length == 1 &&
                          (R.push(A[x]), A[x][0].getOwner().remove(A[x][0]));
                      (s.push(R),
                        this.graphManager.resetAllNodes(),
                        this.graphManager.resetAllEdges());
                    }
                ...
                (d.prototype.findPlaceforPrunedNode = function (s) {
                  ...
                  if (R > 0)
                    for (var F = A; F <= C; F++)
                      G[0] +=
                        this.grid[F][R - 1].length + this.grid[F][R].length - 1;
                  if (C < this.grid.length - 1)
                    for (var F = R; F <= x; F++)
                      G[1] +=
                        this.grid[C + 1][F].length + this.grid[C][F].length - 1;
                  if (x < this.grid[0].length - 1)
                    for (var F = A; F <= C; F++)
                      G[2] +=
                        this.grid[F][x + 1].length + this.grid[F][x].length - 1;
                  if (A > 0)
                    for (var F = R; F <= x; F++)
                      G[3] +=
                        this.grid[A - 1][F].length + this.grid[A][F].length - 1;
            ...
            function (m, y, r) {
              ...
              var E = function (L) {
                (L.nodeRepulsion != null &&
                  (i.DEFAULT_REPULSION_STRENGTH = e.DEFAULT_REPULSION_STRENGTH =
                    L.nodeRepulsion),
                  L.idealEdgeLength != null &&
                    (i.DEFAULT_EDGE_LENGTH = e.DEFAULT_EDGE_LENGTH =
                      L.idealEdgeLength),
                  L.edgeElasticity != null &&
                    (i.DEFAULT_SPRING_STRENGTH = e.DEFAULT_SPRING_STRENGTH =
                      L.edgeElasticity),
                  L.nestingFactor != null &&
                    (i.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      e.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                        L.nestingFactor),
                  L.gravity != null &&
                    (i.DEFAULT_GRAVITY_STRENGTH = e.DEFAULT_GRAVITY_STRENGTH =
                      L.gravity),
                  L.numIter != null &&
                    (i.MAX_ITERATIONS = e.MAX_ITERATIONS = L.numIter),
                  L.gravityRange != null &&
              ...
              ((l.prototype.run = function () {
                ...
                this.gm = s;
                var h = this.options.eles.nodes(),
                  u = this.options.eles.edges();
                ((this.root = s.addRoot()),
                  this.processChildrenList(
                    this.root,
                    this.getTopMostNodes(h),
                    d,
                  ));
                ...
                var _ = function (M, G) {
                  ...
                  U = function X() {
                    ...
                    if (F) {
                      (d.checkLayoutSuccess() &&
                        !d.isSubLayout &&
                        d.doPostLayout(),
                        d.tilingPostLayout && d.tilingPostLayout(),
                        (d.isLayoutFinished = !0),
                ...
                return (
                  d.addListener("layoutstarted", function () {
                    N.options.animate === "during" &&
                ...
                (l.prototype.processChildrenList = function (D, L, O) {
                  for (var d = L.length, N = 0; N < d; N++) {
                      ...
                      (s.outerWidth() != null && s.outerHeight() != null
                        ? (u = D.add(
                            new g(
                              ...
                              new v(parseFloat(p.w), parseFloat(p.h)),
                            ),
                          ))
                        : (u = D.add(new g(this.graphManager))),
                      (u.id = s.data("id")),
                      (u.paddingLeft = parseInt(s.css("padding"))),
                      (u.paddingTop = parseInt(s.css("padding"))),
                    ...
                    if (
                      ((this.idToLNode[s.data("id")] = u),
                      isNaN(u.rect.x) && (u.rect.x = 0),
                      isNaN(u.rect.y) && (u.rect.y = 0),
                      h != null && h.length > 0)
                    ) {
                      var x;
                      ((x = O.getGraphManager().add(O.newGraph(), u)),
                        this.processChildrenList(x, h, O));
                    }
                  }
                }),
...
var at = (function () {
  var I = S(function (O, d, N, s) {
    ...
    T = {
      ...
      performAction: S(function (d, N, s, h, u, p, A) {
        var C = p.length - 1;
        switch (u) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            (h.getLogger().info("Node: ", p[C].id),
              h.addNode(p[C - 1].length, p[C].id, p[C].descr, p[C].type));
            break;
          case 16:
            (h.getLogger().trace("Icon: ", p[C]),
          ...
          case 18:
            ...
            break;
          case 19:
            (h.getLogger().trace("Node: ", p[C].id),
              h.addNode(0, p[C].id, p[C].descr, p[C].type));
            break;
          case 20:
            h.decorateNode({ icon: p[C] });
            break;
          case 25:
            (h.getLogger().trace("node found ..", p[C - 2]),
              (this.$ = {
                id: p[C - 1],
                descr: p[C - 1],
          ...
          case 26:
            ...
            break;
          case 27:
            (h.getLogger().trace("node found ..", p[C - 3]),
              (this.$ = {
                id: p[C - 3],
                descr: p[C - 1],
                type: h.getType(p[C - 2], p[C]),
      ...
      parse: S(function (d) {
        ...
        function H() {
          ...
          return (
            (V = h.pop() || M.lex() || U),
            typeof V != "number" &&
              (V instanceof Array && ((h = V), (V = h.pop())),
              (V = N.symbols_[V] || V)),
            V
          );
        }
          ...
          switch ($[0]) {
            ...
            case 2:
              ...
              (j &&
                ...
                u.push(Q.$),
                p.push(Q._$),
                (gt = A[s[s.length - 2]][s[s.length - 1]]),
                s.push(gt));
              break;
            case 3:
              return !0;
        ...
        unput: S(function (d) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: s
                ? (s.length === h.length ? this.yylloc.first_column : 0) +
                  h[h.length - s.length].length -
                  s[0].length
                : this.yylloc.first_column - N,
            }),
            this.options.ranges &&
              (this.yylloc.range = [u[0], u[0] + this.yyleng - N]),
...
` +
        ...
        test_match: S(function (d, N) {
          ...
          if (
            (this.options.backtrack_lexer &&
              ...
              this.options.ranges &&
                (u.yylloc.range = this.yylloc.range.slice(0))),
            (h = d[0].match(/(?:\r\n?|\n).*/g)),
            h && (this.yylineno += h.length),
            (this.yylloc = {
        ...
        next: S(function () {
          ...
          for (var u = this._currentRules(), p = 0; p < u.length; p++)
            if (
              ((s = this._input.match(this.rules[u[p]])),
              s && (!N || s[0].length > N[0].length))
            ) {
              if (((N = s), (h = p), this.options.backtrack_lexer)) {
                if (((d = this.test_match(s, u[p])), d !== !1)) return d;
                if (this._backtrack) {
                  N = !1;
                  devconx;
                } else return !1;
          ...
          return N
            ? ((d = this.test_match(N, u[h])), d !== !1 ? d : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: S(function (N, s, h, u) {
          switch (h) {
            case 0:
            ...
            case 25:
              return (
                N.getLogger().trace("description:", s.yytext),
                "NODE_DESCR"
              );
            case 26:
              this.popState();
...
var Pt = at,
  ...
  Xt = S(function (I) {
    for (let w = Z.length - 1; w >= 0; w--) if (Z[w].level < I) return Z[w];
    return null;
  }, "getParent"),
  kt = S(() => (Z.length > 0 ? Z[0] : null), "getMindmap"),
  Ht = S((I, w, f, m) => {
    var i, o;
    z.info("addNode", I, w, f, m);
    const y = ot();
    let r =
      ((i = y.mindmap) == null ? void 0 : i.padding) ?? it.mindmap.padding;
    switch (m) {
      case W.ROUNDED_RECT:
      case W.RECT:
      case W.HEXAGON:
    ...
    const t = {
        ...
        children: [],
        width:
          ((o = y.mindmap) == null ? void 0 : o.maxNodeWidth) ??
          it.mindmap.maxNodeWidth,
        padding: r,
      },
      e = Xt(I);
    if (e) (e.children.push(t), Z.push(t));
    else if (Z.length === 0) Z.push(t);
    else
      throw new Error(
  ...
  zt = jt,
  Kt = 12,
  qt = S(function (I, w, f, m) {
    (w
      .append("path")
      .attr("id", "node-" + f.id)
      .attr("class", "node-bkg node-" + I.type2Str(f.type))
      .attr(
        "d",
...
var ie = S(function (I, w, f) {
    const m = f.height,
      r = m / 4,
      t = f.width - f.padding + 2 * r,
      e = [
        { x: r, y: 0 },
        { x: t - r, y: 0 },
        { x: t, y: -m / 2 },
  ...
  se = S(async function (I, w, f, m, y) {
    ...
    let i = "section-" + t;
    (t < 0 && (i += " section-root"),
      e.attr("class", (f.class ? f.class + " " : "") + "mindmap-node " + i));
    const o = e.append("g"),
      g = e.append("g"),
      a = f.descr.replace(
        /(<br\/*>)/g,
...
`,
    ...
    (await Ct(
      g,
      a,
      { useHtmlLabels: r, width: f.width, classes: "mindmap-node-label" },
      y,
    ),
      r ||
        g
    ...
    const v = g.node().getBBox(),
      [n] = Rt(y.fontSize);
    if (
      ((f.height = v.height + n * 1.1 * 0.5 + f.padding),
      (f.width = v.width + 2 * f.padding),
      f.icon)
    )
      if (f.type === I.nodeType.CIRCLE)
        ((f.height += 50),
          ...
          e
            ...
            .append("i")
            .attr("class", "node-icon-" + t + " " + f.icon),
          g.attr(
            "transform",
            "translate(" +
              f.width / 2 +
              ", " +
              (f.height / 2 - 1.5 * f.padding) +
              ")",
          ));
      else {
        f.width += 50;
        ...
        (e
          ...
          .attr("width", "60px")
          .attr("height", f.height)
          .attr("style", "text-align: center;margin-top:" + l / 2 + "px;")
          .append("div")
          .attr("class", "icon-container")
          .append("i")
          .attr("class", "node-icon-" + t + " " + f.icon),
      ...
      const c = (f.width - v.width) / 2,
        l = (f.height - v.height) / 2;
...
async function lt(I, w, f, m, y) {
  (await se(I, w, f, m, y),
    f.children &&
      (await Promise.all(
        f.children.map((r, t) => lt(I, w, r, m < 0 ? t : m, y)),
      )));
}
S(lt, "drawNodes");
function Et(I, w) {
    ...
    if (f[0]._private.bodyBounds) {
      ...
      (z.trace("Edge: ", m, y),
        I.insert("path")
          ...
          .attr(
            "class",
            "edge section-edge-" + y.section + " edge-depth-" + y.depth,
          ));
    }
  });
}
  ...
  le = S((I) => {
    ...
    for (let f = 0; f < I.THEME_COLOR_LIMIT; f++)
      ((I["lineColor" + f] = I["lineColor" + f] || I["cScaleInv" + f]),
        mt(I["lineColor" + f])
          ? (I["lineColor" + f] = Ot(I["lineColor" + f], 20))
          : (I["lineColor" + f] = At(I["lineColor" + f], 20)));
    for (let f = 0; f < I.THEME_COLOR_LIMIT; f++) {
      const m = "" + (17 - 3 * f);
      w += `
...
`,
  ...
  ge = ce,
  de = { db: zt, renderer: he, parser: Pt, styles: ge };
