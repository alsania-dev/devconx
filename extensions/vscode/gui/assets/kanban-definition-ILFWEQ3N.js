import { g as fe } from "./chunk-E2GYISFI.js";
import {
  _ as c,
  l as te,
  c as W,
      ...
      performAction: c(function (s, n, a, o, u, e, B) {
        ...
        switch (u) {
          ...
          case 15:
            ...
            break;
          case 16:
            (o.getLogger().info("Node: ", e[l].id),
              o.addNode(e[l - 1].length, e[l].id, e[l].descr, e[l].type));
            break;
          case 17:
            (o.getLogger().trace("Icon: ", e[l]),
          ...
          case 20:
            ...
            break;
          case 21:
            (o.getLogger().trace("Node: ", e[l].id),
              o.addNode(0, e[l].id, e[l].descr, e[l].type));
            break;
          case 22:
            o.decorateNode({ icon: e[l] });
            break;
      ...
      parse: c(function (s) {
        ...
        function ae() {
          ...
          return (
            (S = o.pop() || b.lex() || re),
            typeof S != "number" &&
              (S instanceof Array && ((o = S), (S = o.pop())),
              (S = n.symbols_[S] || S)),
            S
          );
        }
        ...
        unput: c(function (s) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: a
                ? (a.length === o.length ? this.yylloc.first_column : 0) +
                  o[o.length - a.length].length -
                  a[0].length
...
` +
        ...
        next: c(function () {
          ...
          for (var u = this._currentRules(), e = 0; e < u.length; e++)
            if (
              ((a = this._input.match(this.rules[u[e]])),
...
` +
        ...
        performAction: c(function (n, a, o, u) {
          switch (o) {
            ...
            case 31:
              return (
                n.getLogger().trace("description:", a.yytext),
                "NODE_DESCR"
              );
            case 32:
              this.popState();
...
var xe = $,
  ...
  Oe = c((t, g, d, r, p) => {
    ...
    const h = {
      ...
      label: G(d, E),
      width:
        ((w = E.mindmap) == null ? void 0 : w.maxNodeWidth) ??
        K.mindmap.maxNodeWidth,
      padding: f,
      isGroup: !1,
    };
    if (p !== void 0) {
...
` +
      ...
      if (
        i.shape &&
        (i.shape !== i.shape.toLowerCase() || i.shape.includes("_"))
      )
        throw new Error(
          `No such shape: ${i.shape}. Shape names should be lowercase.`,
        );
      (i != null &&
        i.shape &&
        i.shape === "kanbanItem" &&
        (h.shape = i == null ? void 0 : i.shape),
        i != null && i.label && (h.label = i == null ? void 0 : i.label),
        i != null &&
          i.icon &&
          (h.icon = i == null ? void 0 : i.icon.toString()),
        i != null &&
          i.assigned &&
          (h.assigned = i == null ? void 0 : i.assigned.toString()),
        i != null &&
          i.ticket &&
          (h.ticket = i == null ? void 0 : i.ticket.toString()),
        i != null &&
          i.priority &&
          (h.priority = i == null ? void 0 : i.priority));
    }
    const L = De(t);
  ...
  we = c((t) => {
    ...
    const g = W(),
      d = D[D.length - 1];
    (t.icon && (d.icon = G(t.icon, g)),
      t.class && (d.cssClasses = G(t.class, g)));
  }, "decorateNode"),
  Ae = c((t) => {
    switch (t) {
      case y.DEFAULT:
...
` + t,
    ...
    for (const m of w) {
      ...
      ((x = Math.max(
        x,
        (U = _ == null ? void 0 : _.labelBBox) == null ? void 0 : U.height,
      )),
        H.push(_));
    }
    let P = 0;
