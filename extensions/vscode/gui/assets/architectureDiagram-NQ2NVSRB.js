...
import { p as fr } from "./chunk-353BL4L5.js";
import { I as cr } from "./chunk-AACKK3MU.js";
import { p as gr } from "./treemap-FKARHQ26.js";
import { c as Ge } from "./cytoscape.esm.js";
import { g as ur } from "./XCircleIcon.js";
import "./_baseUniq.js";
      ...
      (function (C, X) {
        (function (G, L) {
          ...
          return (function (A) {
            var G = {};
            function L(g) {
              if (G[g]) return G[g].exports;
              var l = (G[g] = { i: g, l: !1, exports: {} });
              return (
                A[g].call(l.exports, l, l.exports, L),
                (l.l = !0),
                l.exports
              );
            }
            ...
            function (A, G, L) {
              ...
              ((r.prototype.getSource = function () {
                ...
                (r.prototype.getOtherEndInGraph = function (f, i) {
                  for (
                    var u = this.getOtherEnd(f),
                      t = i.getGraphManager().getRoot();
                    ;
                  ) {
            ...
            function (A, G, L) {
              ...
              ((i.prototype.getEdges = function () {
                ...
                (i.prototype.scatter = function () {
                  ...
                  ((s = r.WORLD_CENTER_Y + e.nextDouble() * (T - h) + h),
                    (this.rect.x = t),
                    (this.rect.y = s));
                }),
              ...
              ((s.prototype.getNodes = function () {
                ...
                (s.prototype.remove = function (c) {
                  ...
                  if (c instanceof e) {
                    ...
                    for (
                      var T = h.edges.slice(), v, d = T.length, N = 0;
                      N < d;
                      N++
                    )
                      ((v = T[N]),
                        v.isInterGraph
                          ? this.graphManager.remove(v)
                          : v.source.owner.remove(v));
                    ...
                    var M = v.source.edges.indexOf(v),
                      P = v.target.edges.indexOf(v);
                    if (!(M > -1 && P > -1))
                      throw "Source and/or target doesn't know this edge!";
                    (v.source.edges.splice(M, 1),
                      v.target != v.source && v.target.edges.splice(P, 1));
                ...
                (s.prototype.updateLeftTop = function () {
                  ...
                  return c == l.MAX_VALUE
                    ? null
                    : (N[0].getParent().paddingLeft != null
                        ? (d = N[0].getParent().paddingLeft)
                        : (d = this.margin),
                      (this.left = h - d),
                      (this.top = c - d),
                ...
                (s.prototype.calcEstimatedSize = function () {
                  for (
                    var c = 0, h = this.nodes, T = h.length, v = 0;
                    v < T;
                    v++
                  ) {
                    var d = h[v];
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.remove = function (r) {
                  if (r instanceof g) {
                    ...
                    if (
                      !(
                        e == this.rootGraph ||
                        (e.parent != null && e.parent.graphManager == this)
                      )
                    )
                    ...
                    var o;
                    u = s.length;
                    for (var t = 0; t < u; t++) ((o = s[t]), e.remove(o));
                    ...
                    if (
                      ...
                      !(
                        i.source.owner != null &&
                        i.source.owner.getGraphManager() != null
                      ))
                    )
                ...
                (a.prototype.getAllNodes = function () {
                  if (this.allNodes == null) {
                    for (
                      var r = [], e = this.getGraphs(), f = e.length, i = 0;
                      i < f;
                      i++
                    )
                  ...
                  for (
                    ...
                    for (i = e.getOwner(); r.lca == null; ) {
                      for (
                        ...
                        ((r.targetInLca = u.getParent()),
                          (u = r.targetInLca.getOwner()));
                      }
                      if (i == this.rootGraph) break;
                      r.lca == null &&
                        ((r.sourceInLca = i.getParent()),
                        (i = r.sourceInLca.getOwner()));
                    }
                    if (r.lca == null) throw "assert failed";
                  }
                }),
                ...
                (a.prototype.calcInclusionTreeDepths = function (r, e) {
                  ...
                  for (var f, i = r.getNodes(), u = i.length, t = 0; t < u; t++)
                    ((f = i[t]),
                      ...
                      f.child != null &&
                        this.calcInclusionTreeDepths(f.child, e + 1));
                }),
              ...
              ((l.calcSeparationAmount = function (a, r, e, f) {
                ...
                (l.angleOfVector = function (a, r, e, f) {
                  ...
                  return (
                    a !== e
                      ? ((i = Math.atan((f - r) / (e - a))),
                        e < a ? (i += Math.PI) : f < r && (i += this.TWO_PI))
                      : f < r
                ...
                (l.findCircleLineIntersections = function (
                  ...
                  var s = (e - a) * (e - a) + (f - r) * (f - r),
                    o = 2 * ((a - i) * (e - a) + (r - u) * (f - r)),
                    c = (a - i) * (a - i) + (r - u) * (r - u) - t * t,
                    h = o * o - 4 * s * c;
                  if (h >= 0) {
                    var T = (-o + Math.sqrt(o * o - 4 * s * c)) / (2 * s),
                      v = (-o - Math.sqrt(o * o - 4 * s * c)) / (2 * s),
                      d = null;
            ...
            function (A, G, L) {
              function g() {}
              ((g.MAX_VALUE = 2147483647),
                (g.MIN_VALUE = -2147483648),
                (A.exports = g));
            },
            function (A, G, L) {
              var g = (function () {
            ...
            function (A, G, L) {
              ...
              ((g.prototype.getX = function () {
                ...
                (g.prototype.setLocation = function (l, a, r) {
                ...
                (s.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  for (var c = 0; c < o.length; c++) {
                    ...
                    if (h.bendpoints.length > 0) {
                      for (
                        var T = this.edgeToDummyNodes.get(h), v = 0;
                        v < T.length;
                        v++
                      ) {
                        var d = T[v],
                          N = new i(d.getCenterX(), d.getCenterY()),
                          S = h.bendpoints.get(v);
                ...
                (l.prototype.transformX = function (a) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.ldeviceOrgX +
                        ((a - this.lworldOrgX) * this.ldeviceExtX) / e),
                    r
                  );
                }),
                (l.prototype.transformY = function (a) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.ldeviceOrgY +
                        ((a - this.lworldOrgY) * this.ldeviceExtY) / e),
                    r
                  );
                }),
                (l.prototype.inverseTransformX = function (a) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.lworldOrgX +
                        ((a - this.ldeviceOrgX) * this.lworldExtX) / e),
                    r
                  );
                }),
                (l.prototype.inverseTransformY = function (a) {
                  ...
                  return (
                    e != 0 &&
                      (r =
                        this.lworldOrgY +
                        ((a - this.ldeviceOrgY) * this.lworldExtY) / e),
                    r
                  );
                }),
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t,
                      ...
                      T,
                      v,
                      d = this.getGraphManager().getAllEdges(),
                      N = 0;
                    N < d.length;
                    N++
                  )
                    ((t = d[N]),
                      ...
                      t.isInterGraph &&
                        ...
                        (v = t.getTargetInLca().getEstimatedSize()),
                        this.useSmartIdealEdgeLengthCalculation &&
                          (t.idealLength += T + v - 2 * r.SIMPLE_NODE_SIZE),
                ...
                (i.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      ...
                      ((h = v[o]),
                        this.calculateRepulsionForceOfANode(h, d, t, s),
                        d.add(h));
                  else
                ...
                (i.prototype.calcRepulsionForce = function (t, s) {
                  var o = t.getRect(),
                    ...
                    K;
                  if (o.intersects(c)) {
                    (e.calcSeparationAmount(o, c, h, a.DEFAULT_EDGE_LENGTH / 2),
                      (P = 2 * h[0]),
                      (K = 2 * h[1]));
                    var Y =
                    ...
                    ((t.repulsionForceX -= Y * P),
                      ...
                      (s.repulsionForceY += Y * K));
                  } else
                    (this.uniformLeafNodeSizes &&
                    t.getChild() == null &&
                    s.getChild() == null
                      ? ((v = c.getCenterX() - o.getCenterX()),
                        (d = c.getCenterY() - o.getCenterY()))
                      : (e.getIntersection(o, c, T),
                        (v = T[2] - T[0]),
                        (d = T[3] - T[1])),
                      Math.abs(v) < a.MIN_REPULSION_DIST &&
                        (v = f.sign(v) * a.MIN_REPULSION_DIST),
                      Math.abs(d) < a.MIN_REPULSION_DIST &&
                        (d = f.sign(d) * a.MIN_REPULSION_DIST),
                      (N = v * v + d * d),
                      (S = Math.sqrt(N)),
                      (M =
                ...
                (i.prototype.calcGravitationalForce = function (t) {
                  ...
                  ((s = t.getOwner()),
                    ...
                    (h = t.getCenterX() - o),
                    (T = t.getCenterY() - c),
                    (v = Math.abs(h) + t.getWidth() / 2),
                    (d = Math.abs(T) + t.getHeight() / 2),
                ...
                (i.prototype.addNodeToGrid = function (t, s, o) {
                  ...
                  for (var d = c; d <= h; d++)
                    for (var N = T; N <= v; N++)
                      (this.grid[d][N].push(t),
                        t.setGridCoordinates(c, h, T, v));
                }),
                ...
                (i.prototype.calculateRepulsionForceOfANode = function (
                  t,
                  s,
                  o,
                  c,
                  ...
                  if (
                    ...
                    for (
                      var T, v = this.grid, d = t.startX - 1;
                      d < t.finishX + 2;
                      d++
                    )
                      for (var N = t.startY - 1; N < t.finishY + 2; N++)
                        if (
                          !(d < 0 || N < 0 || d >= v.length || N >= v[0].length)
                        ) {
            ...
            function (A, G, L) {
              ...
              ((l.prototype.add = function (a) {
                ...
                (l.prototype.addAllTo = function (a) {
                  for (
                    var r = Object.keys(this.set), e = r.length, f = 0;
                    f < e;
                    f++
                  )
                    a.push(this.set[r[f]]);
              ...
              ((g.multMat = function (l, a) {
                ...
                (g.transpose = function (l) {
                  for (var a = [], r = 0; r < l[0].length; r++) {
                    a[r] = [];
                    for (var e = 0; e < l.length; e++) a[r][e] = l[e][r];
                  }
                  return a;
                }),
                (g.multCons = function (l, a) {
                  for (var r = [], e = 0; e < l.length; e++) r[e] = l[e] * a;
                  return r;
                }),
                (g.minusOp = function (l, a) {
                  for (var r = [], e = 0; e < l.length; e++) r[e] = l[e] - a[e];
                  return r;
                }),
                (g.dotProduct = function (l, a) {
                  for (var r = 0, e = 0; e < l.length; e++) r += l[e] * a[e];
                  return r;
                }),
                (g.mag = function (l) {
                ...
                (g.multGamma = function (l) {
                  for (var a = [], r = 0, e = 0; e < l.length; e++) r += l[e];
                  r *= -1 / l.length;
                  for (var f = 0; f < l.length; f++) a[f] = r + l[f];
                  return a;
                }),
                (g.multL = function (l, a, r) {
                  for (
                    var e = [], f = [], i = [], u = 0;
                    u < a[0].length;
                    u++
              ...
              var a = L(11),
                r = (function () {
                  function e(f, i) {
                    ...
                    var u = void 0;
                    (f instanceof a ? (u = f.size()) : (u = f.length),
                      this._quicksort(f, 0, u - 1));
                  }
                  return (
                    g(e, [
                      {
                        ...
                        value: function (i, u, t) {
                          if (u < t) {
                            ...
                            (this._quicksort(i, u, s),
                              this._quicksort(i, s + 1, t));
                          }
                        },
                      },
                      {
            ...
            function (A, G, L) {
              ...
              ((g.svd = function (l) {
                ...
                for (
                  ...
                  if (t < i) {
                    ...
                    for (var s = t; s < this.m; s++)
                      this.s[t] = g.hypot(this.s[t], l[s][t]);
                    if (this.s[t] !== 0) {
                  ...
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      for (var h = 0, T = t; T < this.m; T++)
                        h += l[T][t] * l[T][c];
                      h = -h / l[t][t];
                      for (var v = t; v < this.m; v++) l[v][c] += h * l[v][t];
                    }
                    r[c] = l[t][c];
                  }
                  if (
                    ...
                    for (var d = t; d < this.m; d++) this.U[d][t] = l[d][t];
                  if (t < u) {
                    r[t] = 0;
                ...
                for (
                  var B = n - 1, _ = Math.pow(2, -52), lt = Math.pow(2, -966);
                  n > 0;
                ) {
                  var J = void 0,
                    Rt = void 0;
                  for (J = n - 2; J >= -1 && J !== -1; J--)
                    if (
                      Math.abs(r[J]) <=
                      lt + _ * (Math.abs(this.s[J]) + Math.abs(this.s[J + 1]))
                    ) {
                      r[J] = 0;
                      break;
                    }
                  if (J === n - 2) Rt = 4;
                    ...
                    for (Lt = n - 1; Lt >= J && Lt !== J; Lt--) {
                      var vt =
                        (Lt !== n ? Math.abs(r[Lt]) : 0) +
                        (Lt !== J + 1 ? Math.abs(r[Lt - 1]) : 0);
                    ...
                    case 1:
                      {
                        ...
                        for (var ut = n - 2; ut >= J; ut--) {
                          ...
                          for (var mt = 0; mt < this.n; mt++)
                            ((Tt =
                              At * this.V[mt][ut] + Dt * this.V[mt][n - 1]),
                              (this.V[mt][n - 1] =
                                -Dt * this.V[mt][ut] + At * this.V[mt][n - 1]),
                              (this.V[mt][ut] = Tt));
                        }
                      }
                      break;
                    case 2:
                      {
                        ...
                        for (var St = J; St < n; St++) {
                          ...
                          for (var bt = 0; bt < this.m; bt++)
                            ((Vt =
                              Xt * this.U[bt][St] + Ut * this.U[bt][J - 1]),
                              (this.U[bt][J - 1] =
                                -Ut * this.U[bt][St] + Xt * this.U[bt][J - 1]),
                              (this.U[bt][St] = Vt));
                        }
                      }
                      break;
                    case 3:
                      {
                        ...
                        (function (Nt, Mt) {
                          ...
                          (gt = at / (k + gt)));
                        for (
                          var ot = ($ + Bt) * ($ - Bt) + gt, tt = $ * Q, j = J;
                          j < n - 1;
                          j++
                        ) {
                          var dt = g.hypot(ot, tt),
                            wt = ot / dt,
                            yt = tt / dt;
                          (j !== J && (r[j - 1] = dt),
                            (ot = wt * this.s[j] + yt * r[j]),
                            (r[j] = wt * r[j] - yt * this.s[j]),
                            (tt = yt * this.s[j + 1]),
                            (this.s[j + 1] = wt * this.s[j + 1]));
                          for (var It = 0; It < this.n; It++)
                            ((dt = wt * this.V[It][j] + yt * this.V[It][j + 1]),
                              (this.V[It][j + 1] =
                                -yt * this.V[It][j] + wt * this.V[It][j + 1]),
                              (this.V[It][j] = dt));
                          if (
                            ((dt = g.hypot(ot, tt)),
                            (wt = ot / dt),
                            (yt = tt / dt),
                            (this.s[j] = dt),
                            (ot = wt * r[j] + yt * this.s[j + 1]),
                            (this.s[j + 1] = -yt * r[j] + wt * this.s[j + 1]),
                            (tt = yt * r[j + 1]),
                            (r[j + 1] = wt * r[j + 1]),
                            j < this.m - 1)
                          )
                            for (var ft = 0; ft < this.m; ft++)
                              ((dt =
                                wt * this.U[ft][j] + yt * this.U[ft][j + 1]),
                                (this.U[ft][j + 1] =
                                  -yt * this.U[ft][j] + wt * this.U[ft][j + 1]),
                                (this.U[ft][j] = dt));
                        }
                        r[n - 2] = ot;
                      }
                        ...
                        for (; J < B && !(this.s[J] >= this.s[J + 1]); ) {
                          ...
                          if (
                            ...
                            for (var ct = 0; ct < this.n; ct++)
                              ((Ct = this.V[ct][J + 1]),
                                (this.V[ct][J + 1] = this.V[ct][J]),
                                (this.V[ct][J] = Ct));
                          if (J < this.m - 1)
                            for (var ht = 0; ht < this.m; ht++)
                              ((Ct = this.U[ht][J + 1]),
                                (this.U[ht][J + 1] = this.U[ht][J]),
                                (this.U[ht][J] = Ct));
                          J++;
                        }
                        n--;
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (var i = 1; i < this.iMax; i++)
                          ((this.grid[i][0] =
                            this.grid[i - 1][0] + this.gap_penalty),
            ...
            var G = {
                ...
                765: (a, r, e) => {
                  ...
                  ((D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.initConstraintVariables = function () {
                      ...
                      for (
                        var m = this.graphManager.getAllNodes(), p = 0;
                        p < m.length;
                        p++
                      ) {
                        var E = m[p];
                      ...
                      var y = function O(H) {
                        for (
                          var B = H.getChild().getNodes(), _, lt = 0, J = 0;
                          J < B.length;
                          J++
                        )
                          ((_ = B[J]),
                            _.getChild() == null
                              ? n.fixedNodeSet.has(_.id) && (lt += 100)
                              : (lt += O(_)));
                        return lt;
                      };
                      if (this.constraints.fixedNodeConstraint) {
                        ...
                        for (
                          var m = this.graphManager.getAllNodes(), E, p = 0;
                          p < m.length;
                          p++
                        )
                      ...
                      if (this.constraints.relativePlacementConstraint) {
                        ...
                        if (
                          ...
                          this.fixedNodeSet.forEach(function (O) {
                            (n.fixedNodesOnHorizontal.add(O),
                              n.fixedNodesOnVertical.add(O));
                          }),
                              ...
                              function (O) {
                                if (O.left) {
                                  ...
                                  (n.nodesInRelativeHorizontal.includes(H) ||
                                    ...
                                    n.nodesInRelativeHorizontal.includes(B) ||
                                      ...
                                      n.dummyToNodeForVerticalAlignment.has(B)
                                        ...
                                        : n.nodeToTempPositionMapHorizontal.set(
                                            B,
                                            n.idToNodeMap.get(B).getCenterX(),
                                          )),
                                    n.nodeToRelativeConstraintMapHorizontal
                                      .get(H)
                                      .push({ right: B, gap: O.gap }),
                                    n.nodeToRelativeConstraintMapHorizontal
                                      .get(B)
                                  ...
                                  (n.nodesInRelativeVertical.includes(_) ||
                                    ...
                                    n.nodesInRelativeVertical.includes(lt) ||
                                      (n.nodesInRelativeVertical.push(lt),
                                      n.nodeToRelativeConstraintMapVertical.set(
                                        lt,
                                        [],
                                      ),
                                      n.dummyToNodeForHorizontalAlignment.has(
                                        ...
                                        : n.nodeToTempPositionMapVertical.set(
                                            lt,
                                            n.idToNodeMap.get(lt).getCenterY(),
                                          )),
                                    n.nodeToRelativeConstraintMapVertical
                                      .get(_)
                                      .push({ bottom: lt, gap: O.gap }),
                                    n.nodeToRelativeConstraintMapVertical
                                      .get(lt)
                            ...
                            function (O) {
                              if (O.left) {
                                var H = w.has(O.left) ? w.get(O.left) : O.left,
                                  B = w.has(O.right) ? w.get(O.right) : O.right;
                                (q.has(H) ? q.get(H).push(B) : q.set(H, [B]),
                                  q.has(B) ? q.get(B).push(H) : q.set(B, [H]));
                              } else {
                                var _ = R.has(O.top) ? R.get(O.top) : O.top,
                                  lt = R.has(O.bottom)
                                    ? R.get(O.bottom)
                                    : O.bottom;
                                (V.has(_) ? V.get(_).push(lt) : V.set(_, [lt]),
                                  V.has(lt)
                                    ? V.get(lt).push(_)
                                    : V.set(lt, [_]));
                              }
                              ...
                              return (
                                H.forEach(function (vt, it) {
                                  if (!Rt.has(it)) {
                                    ...
                                    var ut = it;
                                    for (
                                      J.push(ut), Rt.add(ut), _[Lt].push(ut);
                                      J.length != 0;
                                    ) {
                                      ((ut = J.shift()),
                                        B.has(ut) && (lt[Lt] = !0));
                                ...
                                if (!n.fixedNodesOnHorizontal.has(z)) {
                                  ...
                                  (n.dummyToNodeForVerticalAlignment.has(z)
                                    ...
                                    n.dummyToNodeForVerticalAlignment.has(z)
                                      ...
                                      : (n.idToNodeMap.get(z).displacementX =
                                          O));
                                }
                              },
                            ),
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForVerticalAlignment.has(x[y])
                                  ...
                                  : (this.idToNodeMap.get(x[y]).displacementX =
                                      0);
                            else {
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (
                                  ...
                                  ((q +=
                                    U.length *
                                    this.idToNodeMap.get(U[0]).displacementX),
                                    (V += U.length));
                                } else
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              for (var y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ...
                                  : (this.idToNodeMap.get(x[y]).displacementY =
                                      0);
                            else {
                              for (var q = 0, V = 0, y = 0; y < x.length; y++)
                                if (
                                  ...
                                  ((q +=
                                    U.length *
                                    this.idToNodeMap.get(U[0]).displacementY),
                                    (V += U.length));
                                } else
                                  ((q += this.idToNodeMap.get(
                                    x[y],
                    ...
                    (D.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        R % p == 0 &&
                          ((I = 0),
                          (y = E),
                          R != 0 && (y += o.DEFAULT_COMPONENT_SEPERATION),
                          (E = 0));
                        var W = n[R],
                        ...
                        ((m.x = I),
                          ...
                          (I = Math.floor(
                            w.x + o.DEFAULT_COMPONENT_SEPERATION,
                          )));
                      }
                      this.transform(
                        new d(
                          T.WORLD_CENTER_X - w.x / 2,
                          T.WORLD_CENTER_Y - w.y / 2,
                        ),
                      );
                    }),
                    ...
                    (D.branchRadialLayout = function (n, m, p, E, y, I) {
                      ...
                      m != null && U--;
                      for (
                        var et = 0, z = V.length, O, H = n.getEdgesBetween(m);
                        H.length > 1;
                      ) {
                        var B = H[0];
                        H.splice(0, 1);
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          ((V.id = x),
                            ...
                            (n.idToDummyNode[x] = V));
                          var U = n.getGraphManager().add(n.newGraph(), V),
                            et = q.getChild();
                          et.add(V);
                    ...
                    (D.prototype.adjustLocations = function (
                      n,
                      m,
                      p,
                      E,
                      ...
                      for (var R = m, W = 0; W < n.rows.length; W++) {
                        ...
                        for (var q = 0, V = 0; V < x.length; V++) {
                          ...
                          ((U.rect.x = m),
                            (U.rect.y = p),
                            (m += U.rect.width + n.horizontalPadding),
                            U.rect.height > q && (q = U.rect.height));
                        }
                      ...
                      ((this.tiledMemberPack = []),
                        Object.keys(n).forEach(function (E) {
                          ...
                          if (
                            ...
                            y.setCenter(
                              p.tiledMemberPack[E].centerX,
                              p.tiledMemberPack[E].centerY,
                            ),
                            (y.labelMarginLeft = 0),
                            (y.labelMarginTop = 0),
                            o.NODE_DIMENSIONS_INCLUDE_LABELS)
                    ...
                    (D.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var V = 0; V < n.length; V++) {
                        ...
                        if (w.rows.length == 0)
                          ...
                          this.canAddHorizontal(w, U.rect.width, U.rect.height)
                        ) {
                          var et = w.rows.length - 1;
                          (w.idealRowWidth ||
                            (et = this.getShortestRowIndex(w)),
                            this.insertNodeToRow(w, U, et, m));
                        } else this.insertNodeToRow(w, U, w.rows.length, m);
                    ...
                    (D.prototype.getShortestRowIndex = function (n) {
                      for (
                        var m = -1, p = Number.MAX_VALUE, E = 0;
                        E < n.rows.length;
                        E++
                      )
                    ...
                    (D.prototype.getLongestRowIndex = function (n) {
                      for (
                        var m = -1, p = Number.MIN_VALUE, E = 0;
                        E < n.rows.length;
                        E++
                      )
                        n.rowWidth[E] > p && ((m = E), (p = n.rowWidth[E]));
                    ...
                    (D.prototype.canAddHorizontal = function (n, m, p) {
                      ...
                      n.rowHeight[I] < p &&
                        I > 0 &&
                        (R = p + n.verticalPadding - n.rowHeight[I]);
                      var W;
                      ...
                      if (
                        ...
                        if (w > 0)
                          for (var et = y; et <= I; et++)
                            U[0] +=
                              this.grid[et][w - 1].length +
                              this.grid[et][w].length -
                              1;
                        if (I < this.grid.length - 1)
                          for (var et = w; et <= R; et++)
                            U[1] +=
                              this.grid[I + 1][et].length +
                              this.grid[I][et].length -
                              1;
                        if (R < this.grid[0].length - 1)
                          for (var et = y; et <= I; et++)
                            U[2] +=
                              this.grid[et][R + 1].length +
                              this.grid[et][R].length -
                              1;
                        if (y > 0)
                          for (var et = w; et <= R; et++)
                            U[3] +=
                              this.grid[y - 1][et].length +
                              this.grid[y][et].length -
                              1;
                        for (
                          var z = M.MAX_VALUE, O, H, B = 0;
                          B < U.length;
                          B++
                        )
                          U[B] < z
                ...
                991: (a, r, e) => {
                  ...
                  ((u.prototype.calculateDisplacement = function () {
                    ...
                    (u.prototype.propogateDisplacementToChildren = function (
                      s,
                      o,
                    ) {
                      for (
                ...
                902: (a, r, e) => {
                  ...
                  ((o.handleConstraints = function (c) {
                    ...
                    h.relativePlacementConstraint &&
                      h.relativePlacementConstraint.forEach(function (F) {
                        !F.gap &&
                          F.gap != 0 &&
                          (F.left
                            ? (F.gap =
                                i.DEFAULT_EDGE_LENGTH +
                                T.get(F.left).getWidth() / 2 +
                                T.get(F.right).getWidth() / 2)
                            : (F.gap =
                                i.DEFAULT_EDGE_LENGTH +
                                T.get(F.top).getHeight() / 2 +
                                T.get(F.bottom).getHeight() / 2));
                      });
                    var Y = function (b, $) {
                            ...
                            ? (dt.push(st),
                              Q ||
                                ($ == "horizontal"
                                  ? tt.set(
                                      st,
                                      v.has(st) ? d[v.get(st)] : k.get(st),
                                    )
                                  : tt.set(
                                      st,
                                      v.has(st) ? N[v.get(st)] : k.get(st),
                                    )))
                            : tt.set(st, Number.NEGATIVE_INFINITY),
                            Q && j.set(st, new Set([st])));
                        }),
                          Q &&
                              ...
                              if (
                                ...
                                (st.forEach(function (ht) {
                                  $ == "horizontal"
                                    ? (tt.set(
                                        ht,
                                        v.has(ht) ? d[v.get(ht)] : k.get(ht),
                                      ),
                                      (Ct += tt.get(ht)))
                                    : (tt.set(
                                        ht,
                                        v.has(ht) ? N[v.get(ht)] : k.get(ht),
                                      ),
                                      (Ct += tt.get(ht)));
                                }),
                                  (Ct = Ct / st.length),
                          ...
                          var wt = function () {
                            ...
                            Ct.forEach(function (ct) {
                              if (tt.get(ct.id) < tt.get(st) + ct.gap)
                                ...
                                } else tt.set(ct.id, tt.get(st) + ct.gap);
                              (ot.set(ct.id, ot.get(ct.id) - 1),
                                ot.get(ct.id) == 0 && dt.push(ct.id),
                                Q && j.set(ct.id, gt(j.get(st), j.get(ct.id))));
                            });
                          };
                          dt.length != 0;
                        )
                        ...
                        if (Q) {
                          ...
                          (j.forEach(function (ft, st) {
                            ...
                            It.forEach(function (ft, st) {
                              ...
                              var ue = (Ct + ht) / 2 - (ct + Wt) / 2,
                                Kt = !0,
                                te = !1,
                                ee = void 0;
                              try {
                                for (
                                  var jt = ft[Symbol.iterator](), se;
                                  !(Kt = (se = jt.next()).done);
                                  Kt = !0
                                ) {
                                  var re = se.value;
                      ...
                      rt = function (b) {
                        ...
                        if (
                          (b.forEach(function (j) {
                            j.left
                              ? d[v.get(j.left)] - d[v.get(j.right)] >= 0
                                ? $++
                                : Q++
                              : N[v.get(j.top)] - N[v.get(j.bottom)] >= 0
                                ? k++
                                : at++;
                          }),
                          $ > Q && k > at)
                      ...
                      n = function (b) {
                        var $ = [],
                          ...
                          at = 0;
                        return (
                          b.forEach(function (gt, ot) {
                            if (!k.has(ot)) {
                              $[at] = [];
                              var tt = ot;
                              for (
                                Q.push(tt), k.add(tt), $[at].push(tt);
                                Q.length != 0;
                              ) {
                                tt = Q.shift();
                                var j = b.get(tt);
                    ...
                    if (
                      ...
                      if (
                        ...
                        (h.fixedNodeConstraint.forEach(function (F, b) {
                          ((E[b] = [F.position.x, F.position.y]),
                            (y[b] = [d[v.get(F.nodeId)], N[v.get(F.nodeId)]]));
                        }),
                          (I = !0));
                        ...
                        (function () {
                          ...
                          if (h.alignmentConstraint.vertical) {
                            for (
                              var b = h.alignmentConstraint.vertical,
                                $ = function (tt) {
                                  var j = new Set();
                                  ...
                                  var dt = new Set(
                                      [].concat(f(j)).filter(function (yt) {
                                        return R.has(yt);
                                      }),
                                    ),
                                    wt = void 0;
                                  (dt.size > 0
                                    ? (wt = d[v.get(dt.values().next().value)])
                                    : (wt = Z(j).x),
                                    b[tt].forEach(function (yt) {
                                      ((E[F] = [wt, N[v.get(yt)]]),
                                        (y[F] = [d[v.get(yt)], N[v.get(yt)]]),
                                        F++);
                                    }));
                                },
                                Q = 0;
                        ...
                        if (V < x.size / 2)
                          (rt(h.relativePlacementConstraint),
                            (I = !1),
                            (w = !1));
                        else {
                          var z = new Map(),
                          ...
                          (q[U].forEach(function (F) {
                            W.get(F).forEach(function (b) {
                              b.direction == "horizontal"
                                ? (z.has(F) ? z.get(F).push(b) : z.set(F, [b]),
                                  z.has(b.id) || z.set(b.id, []),
                                  H.push({ left: F, right: b.id }))
                                : (O.has(F) ? O.get(F).push(b) : O.set(F, [b]),
                                  O.has(b.id) || O.set(b.id, []),
                                  H.push({ top: F, bottom: b.id }));
                            });
                          }),
                            rt(H),
                            (w = !1));
                          var B = D(z, "horizontal"),
                            _ = D(O, "vertical");
                          (q[U].forEach(function (F, b) {
                            ((y[b] = [d[v.get(F)], N[v.get(F)]]),
                              (E[b] = []),
                              B.has(F)
                                ? (E[b][0] = B.get(F))
                                : (E[b][0] = d[v.get(F)]),
                      ...
                      if (I) {
                        for (
                          ...
                          ((J[Lt] = t.multGamma(J[Lt])),
                            (Rt[Lt] = t.multGamma(Rt[Lt])));
                        var vt = t.multMat(J, t.transpose(Rt)),
                          it = s.svd(vt);
                        ...
                        for (var ut = 0; ut < v.size; ut++) {
                          var Tt = [d[ut], N[ut]],
                            At = [lt[0][0], lt[1][0]],
                            Dt = [lt[0][1], lt[1][1]];
                          ((d[ut] = t.dotProduct(Tt, At)),
                            (N[ut] = t.dotProduct(Tt, Dt)));
                        }
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (
                        ...
                        (h.fixedNodeConstraint.forEach(function (F, b) {
                          ...
                          h.fixedNodeConstraint.forEach(function (F) {
                            ((d[v.get(F.nodeId)] = F.position.x),
                              (N[v.get(F.nodeId)] = F.position.y));
                          }));
                      }
                      if (h.alignmentConstraint) {
                        if (h.alignmentConstraint.vertical)
                          for (
                            var xt = h.alignmentConstraint.vertical,
                              St = function (b) {
                                var $ = new Set();
                                ...
                                var Q = new Set(
                                    [].concat(f($)).filter(function (at) {
                                      return R.has(at);
                                    }),
                                  ),
                                  k = void 0;
                                (Q.size > 0
                                  ? (k = d[v.get(Q.values().next().value)])
                                  : (k = Z($).x),
                                  $.forEach(function (at) {
                        ...
                        if (h.alignmentConstraint.horizontal)
                          for (
                            var Xt = h.alignmentConstraint.horizontal,
                              Ut = function (b) {
                                var $ = new Set();
                                Xt[b].forEach(function (at) {
                                  $.add(at);
                      ...
                      h.relativePlacementConstraint &&
                        (function () {
                            ...
                            if (h.alignmentConstraint.vertical)
                              for (
                                var tt = h.alignmentConstraint.vertical,
                                  j = function (Et) {
                                    ($.set("dummy" + Et, []),
                                      tt[Et].forEach(function (Ot) {
                                        (F.set(Ot, "dummy" + Et),
                                          $.get("dummy" + Et).push(Ot),
                                          R.has(Ot) && gt.add("dummy" + Et));
                                      }),
                            ...
                            if (h.alignmentConstraint.horizontal)
                              for (
                                var wt = h.alignmentConstraint.horizontal,
                                  yt = function (Et) {
                                    (Q.set("dummy" + Et, []),
                                      wt[Et].forEach(function (Ot) {
                                        (b.set(Ot, "dummy" + Et),
                                          Q.get("dummy" + Et).push(Ot),
                                          R.has(Ot) && ot.add("dummy" + Et));
                                      }),
                                      at.set(
                                        "dummy" + Et,
                                        N[v.get(wt[Et][0])],
                          ...
                          var ft = new Map(),
                            ...
                            Ct = function (Et) {
                              W.get(Et).forEach(function (Ot) {
                                var Jt = void 0,
                                  Zt = void 0;
                                Ot.direction == "horizontal"
                                  ? ((Jt = F.get(Et) ? F.get(Et) : Et),
                                    F.get(Ot.id)
                                      ? (Zt = {
                                          id: F.get(Ot.id),
                                          gap: Ot.gap,
                                    ...
                                    ft.has(Jt)
                                      ? ft.get(Jt).push(Zt)
                                      : ft.set(Jt, [Zt]),
                                    ft.has(Zt.id) || ft.set(Zt.id, []))
                                  : ((Jt = b.get(Et) ? b.get(Et) : Et),
                                    b.get(Ot.id)
                                      ? (Zt = {
                                          id: b.get(Ot.id),
                                          gap: Ot.gap,
                          ...
                          try {
                            for (
                              var Nt = W.keys()[Symbol.iterator](), Mt;
                              !(ct = (Mt = Nt.next()).done);
                              ct = !0
                            ) {
                              var kt = Mt.value;
                          ...
                          var ee = D(ft, "horizontal", gt, k, Kt),
                            jt = D(st, "vertical", ot, at, te),
                            se = function (Et) {
                              $.get(Et)
                                ? $.get(Et).forEach(function (Ot) {
                          ...
                          try {
                            for (
                              var de = ee.keys()[Symbol.iterator](), Ae;
                              !(re = (Ae = de.next()).done);
                              re = !0
                            ) {
                              var ve = Ae.value;
                          ...
                          try {
                            for (
                              var ye = jt.keys()[Symbol.iterator](), De;
                              !(pe = (De = ye.next()).done);
                              pe = !0
                            ) {
                              var ve = De.value;
                    ...
                    for (var Ht = 0; Ht < S.length; Ht++) {
                      var Bt = S[Ht];
                      Bt.getChild() == null &&
                        Bt.setCenter(d[v.get(Bt.id)], N[v.get(Bt.id)]);
                    }
                  }),
                    (a.exports = o));
                },
            ...
            var G = {
                ...
                548: (a, r, e) => {
                  var f = (function () {
                      function t(s, o) {
                        ...
                        try {
                          for (
                            var d = s[Symbol.iterator](), N;
                            !(h = (N = d.next()).done) &&
                            (c.push(N.value), !(o && c.length === o));
                            h = !0
                          );
                        } catch (S) {
                          ((T = !0), (v = S));
                  ...
                  ((u.getTopMostNodes = function (t) {
                    ...
                    (u.connectComponents = function (t, s, o, c) {
                      var h = new i(),
                        ...
                        Z = function () {
                          ...
                          for (
                            var p = function () {
                              ...
                              n.neighborhood()
                                .nodes()
                                .forEach(function (x) {
                                  s.intersection(n.edgesWith(x)).length > 0 &&
                                    I.merge(x);
                                });
                              for (var w = 0; w < I.length; w++) {
                                var R = I[w];
                                if (
                                  ((d = o.intersection(R.union(R.ancestors()))),
                                  d != null && !T.has(d[0]))
                                ) {
                          ...
                          if (
                            ...
                            v.length == o.length && (M = !0),
                            !M || (M && P > 1))
                          ) {
                            ((N = v[0]),
                              (S = N.connectedEdges().length),
                              v.forEach(function (y) {
                                y.connectedEdges().length < S &&
                                  ((S = y.connectedEdges().length), (N = y));
                              }),
                              K.push(N.id()));
                            var E = t.collection();
                            (E.merge(v[0]),
                      ...
                      while (!M);
                      return (
                        c && K.length > 0 && c.set("dummy" + (c.size + 1), K),
                        Y
                      );
                    }),
                    (u.relocateComponent = function (t, s, o) {
                      if (!o.fixedNodeConstraint) {
                        ...
                        if (o.quality == "draft") {
                          ...
                          try {
                            for (
                              var M = s.nodeIndexes[Symbol.iterator](), P;
                              !(d = (P = M.next()).done);
                              d = !0
                            ) {
                              var K = P.value,
                    ...
                    (u.calcBoundingBox = function (t, s, o, c) {
                      for (
                        ...
                        ((N = s[c.get(D.id())] - D.width() / 2),
                          (S = s[c.get(D.id())] + D.width() / 2),
                          (M = o[c.get(D.id())] - D.height() / 2),
                          (P = o[c.get(D.id())] + D.height() / 2),
                          h > N && (h = N),
                          T < S && (T = S),
                          v > M && (v = M),
                          d < P && (d = P));
                ...
                816: (a, r, e) => {
                  var f = e(548),
                    ...
                    s = e(140).layoutBase.DimensionD,
                    o = e(140).layoutBase.LayoutConstants,
                    c = e(140).layoutBase.FDLayoutConstants,
                    h = e(140).CoSEConstants,
                    T = function (d, N) {
                      var S = d.cy,
                        M = d.eles,
                        P = M.nodes(),
                        ...
                        rt = {};
                      d.randomize &&
                        ((Y = N.nodeIndexes), (Z = N.xCoords), (D = N.yCoords));
                      var n = function (x) {
                        ...
                        p = f.calcParentsWithoutChildren(S, M),
                        E = function W(x, q, V, U) {
                          for (var et = q.length, z = 0; z < et; z++) {
                            ...
                            if (
                              ...
                              if (U.randomize)
                                if (!O.isParent())
                                  ...
                                  var lt = f.calcBoundingBox(O, Z, D, Y);
                                  O.intersection(p).length == 0
                                    ? (B = x.add(
                                        new u(
                                          V.graphManager,
                                          new t(lt.topLeftX, lt.topLeftY),
                                          new s(lt.width, lt.height),
                                        ),
                                      ))
                                    : (B = x.add(
                                        new u(
                            ...
                            else B = x.add(new u(this.graphManager));
                            if (
                              ((B.id = O.data("id")),
                              (B.nodeRepulsion = m(U.nodeRepulsion, O)),
                              (B.paddingLeft = parseInt(O.css("padding"))),
                              (B.paddingTop = parseInt(O.css("padding"))),
                              (B.paddingRight = parseInt(O.css("padding"))),
                              (B.paddingBottom = parseInt(O.css("padding"))),
                              U.nodeDimensionsIncludeLabels &&
                                ((B.labelWidth = O.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).w),
                                (B.labelHeight = O.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).h),
                                (B.labelPosVertical = O.css("text-valign")),
                                (B.labelPosHorizontal = O.css("text-halign"))),
                              (rt[O.data("id")] = B),
                              ...
                              var J = void 0;
                              ((J = V.getGraphManager().add(V.newGraph(), B)),
                                W(J, H, V, U));
                            }
                          }
                        },
                        y = function (x, q, V) {
                          for (var U = 0, et = 0, z = 0; z < V.length; z++) {
                            ...
                            if (
                              ...
                              B &&
                              H !== B &&
                              H.getEdgesBetween(B).length == 0
                            ) {
                              var _ = q.add(x.newEdge(), H, B);
                              ((_.id = O.id()),
                                (_.idealLength = m(d.idealEdgeLength, O)),
                                (_.edgeElasticity = m(d.edgeElasticity, O)),
                                (U += _.idealLength),
                                et++);
                            }
                          }
                        ...
                        I = function (x, q) {
                          (q.fixedNodeConstraint &&
                            (x.constraints.fixedNodeConstraint =
                              q.fixedNodeConstraint),
                            q.alignmentConstraint &&
                              (x.constraints.alignmentConstraint =
                                q.alignmentConstraint),
                      ...
                      (d.nestingFactor != null &&
                        (h.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                          c.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                            d.nestingFactor),
                        d.gravity != null &&
                          (h.DEFAULT_GRAVITY_STRENGTH =
                            c.DEFAULT_GRAVITY_STRENGTH =
                              d.gravity),
                        d.numIter != null &&
                          (h.MAX_ITERATIONS = c.MAX_ITERATIONS = d.numIter),
                        d.gravityRange != null &&
                          (h.DEFAULT_GRAVITY_RANGE_FACTOR =
                        ...
                        d.tilingCompareBy != null &&
                          (h.TILING_COMPARE_BY = d.tilingCompareBy),
                        d.quality == "proof"
                          ? (o.QUALITY = 2)
                          : (o.QUALITY = 0),
                        ...
                        (h.DEFAULT_INCREMENTAL =
                          ...
                          o.DEFAULT_INCREMENTAL =
                            !d.randomize),
                        (h.ANIMATE = c.ANIMATE = o.ANIMATE = d.animate),
                        (h.TILE = d.tile),
                        ...
                        (h.DEFAULT_INCREMENTAL =
                          ...
                          o.DEFAULT_INCREMENTAL =
                            !0),
                        (h.PURE_INCREMENTAL = !d.randomize),
                        (o.DEFAULT_UNIFORM_LEAF_NODE_SIZES =
                        ...
                        f(d, [
                          {
                            ...
                            value: function () {
                              var S = this,
                                ...
                                D = void 0,
                                rt = [];
                              (M.fixedNodeConstraint &&
                                (!Array.isArray(M.fixedNodeConstraint) ||
                                  M.fixedNodeConstraint.length == 0) &&
                                (M.fixedNodeConstraint = void 0),
                                M.alignmentConstraint &&
                                  (M.alignmentConstraint.vertical &&
                                    (!Array.isArray(
                                      M.alignmentConstraint.vertical,
                                    ) ||
                                      M.alignmentConstraint.vertical.length ==
                                        0) &&
                                    (M.alignmentConstraint.vertical = void 0),
                                  M.alignmentConstraint.horizontal &&
                                    (!Array.isArray(
                                      M.alignmentConstraint.horizontal,
                                    ) ||
                                      M.alignmentConstraint.horizontal.length ==
                                        0) &&
                                    (M.alignmentConstraint.horizontal =
                                      void 0)),
                                M.relativePlacementConstraint &&
                                  (!Array.isArray(
                                    ...
                                    M.relativePlacementConstraint.length ==
                                      0) &&
                                  (M.relativePlacementConstraint = void 0));
                              var n =
                                M.fixedNodeConstraint ||
                                M.alignmentConstraint ||
                                M.relativePlacementConstraint;
                              ...
                              if (
                                (P.layoutUtilities &&
                                  M.packComponents &&
                                  ((m = P.layoutUtilities("get")),
                                  m || (m = P.layoutUtilities()),
                                  (p = !0)),
                                K.nodes().length > 0)
                              )
                                if (p) {
                                  ...
                                  if (
                                    ((D = t.connectComponents(P, M.eles, I)),
                                    ...
                                    D.forEach(function (vt, it) {
                                      ((M.eles = vt),
                                        Z.push(h(M, Y[it])),
                                        t.relocateComponent(rt[it], Z[it], M));
                                    });
                                  } else
                                    D.forEach(function (vt, it) {
                                  ...
                                  if (D.length > 1) {
                                            ...
                                            if (
                                              ...
                                              if (M.quality == "draft") {
                                                ...
                                                if (mt.isParent()) {
                                                  ...
                                                  (Xt.push(Y[it].xCoords[St]),
                                                    Xt.push(Y[it].yCoords[St]));
                                                if (xt.isParent()) {
                                                  var Ht = t.calcBoundingBox(
                                                    xt,
                                                    Y[it].xCoords,
                                                    Y[it].yCoords,
                                                    ut,
                                                  ...
                                                  (Ut.push(Y[it].xCoords[Vt]),
                                                    Ut.push(Y[it].yCoords[Vt]));
                                                Tt.edges.push({
                                                  startX: Xt[0],
                                                  startY: Xt[1],
                                                  endX: Ut[0],
                                    ...
                                    if (M.quality == "draft")
                                      ...
                                      O.forEach(function (vt) {
                                        (Object.keys(Z[vt]).forEach(
                                          function (it) {
                                            var ut = Z[vt][it];
                                            ut.setCenter(
                                              ut.getCenterX() + _[lt].dx,
                                              ut.getCenterY() + _[lt].dy,
                                            );
                                          },
                                        ),
                                          lt++);
                                  ...
                                  M.quality == "default" || M.quality == "proof"
                                    ? (Z.push(h(M, Y[0])),
                                      t.relocateComponent(rt[0], Z[0], M))
                                    : t.relocateComponent(rt[0], Y[0], M);
                                }
                              var J = function (it, ut) {
                                if (
                                  ...
                                  var Tt = void 0,
                                    ...
                                    Dt = it.data("id");
                                  return (
                                    Z.forEach(function (xt) {
                                      Dt in xt &&
                                        ((Tt = {
                                          x: xt[Dt].getRect().getCenterX(),
                                          y: xt[Dt].getRect().getCenterY(),
                                        }),
                                        (At = xt[Dt]));
                                    }),
                                    M.nodeDimensionsIncludeLabels &&
                                      (At.labelWidth &&
                                        (At.labelPosHorizontal == "left"
                                          ? (Tt.x += At.labelWidth / 2)
                                          : At.labelPosHorizontal == "right" &&
                                            (Tt.x -= At.labelWidth / 2)),
                                      At.labelHeight &&
                                        (At.labelPosVertical == "top"
                                          ? (Tt.y += At.labelHeight / 2)
                              ...
                              if (
                                ...
                                var Rt = t.calcParentsWithoutChildren(P, K),
                                  Lt = K.filter(function (vt) {
                                    return vt.css("display") == "none";
                                  });
                                ((M.eles = K.not(Lt)),
                                  K.nodes()
                ...
                657: (a, r, e) => {
                  var f = e(548),
                    ...
                    t = function (o) {
                      var c = o.cy,
                        ...
                        q = function (b) {
                          ...
                          if (b) {
                            ...
                            for (var k = 0; k < m; k++) Z[k] = p;
                            for (var at = 0; at < R; at++)
                              ((Y[at] = $), ($ = x($, at, b)));
                          } else {
                            W();
                            for (var Q = 0; Q < R; Q++) x(Y[Q], Q, b);
                          }
                          for (var gt = 0; gt < m; gt++)
                            for (var ot = 0; ot < R; ot++)
                              D[gt][ot] *= D[gt][ot];
                          for (var tt = 0; tt < R; tt++) rt[tt] = [];
                          for (var j = 0; j < R; j++)
                        ...
                        U = function () {
                          ...
                          for (var tt = E, j = E, dt = void 0; ; ) {
                            for (var wt = 0; wt < m; wt++) at[wt] = Q[wt];
                            if (
                              ((Q = i.multGamma(
                                i.multL(i.multGamma(at), D, n),
                              )),
                              (b = i.dotProduct(at, Q)),
                              (Q = i.normalize(Q)),
                              (tt = i.dotProduct(at, Q)),
                              (dt = Math.abs(tt / j)),
                              dt <= 1 + y && dt >= 1)
                            )
                              break;
                          ...
                          for (var yt = 0; yt < m; yt++) at[yt] = Q[yt];
                          for (j = E; ; ) {
                            for (var It = 0; It < m; It++) gt[It] = k[It];
                            if (
                              ((gt = i.minusOp(
                                gt,
                                i.multCons(at, i.dotProduct(at, gt)),
                              )),
                              (k = i.multGamma(i.multL(i.multGamma(gt), D, n))),
                              ($ = i.dotProduct(gt, k)),
                              (k = i.normalize(k)),
                              (tt = i.dotProduct(gt, k)),
                              (dt = Math.abs(tt / j)),
                              dt <= 1 + y && dt >= 1)
                            )
                              break;
                          ...
                          for (var ft = 0; ft < m; ft++) gt[ft] = k[ft];
                          ((P = i.multCons(at, Math.sqrt(Math.abs(b)))),
                            (K = i.multCons(gt, Math.sqrt(Math.abs($)))));
                        };
                      (f.connectComponents(c, h, f.getTopMostNodes(T), d),
                        v.forEach(function (F) {
                          f.connectComponents(
                            c,
                            h,
                            f.getTopMostNodes(F.descendants().intersection(h)),
                            d,
                          );
                        }));
                      ...
                      try {
                        for (
                          var _ = d.keys()[Symbol.iterator](), lt;
                          !(O = (lt = _.next()).done);
                          O = !0
                        ) {
                          var J = lt.value;
                      ...
                      for (var Rt = 0; Rt < N.size; Rt++) M[Rt] = [];
                      (v.forEach(function (F) {
                        for (
                          var b = F.children().intersection(h);
                          b.nodes(":childless").length == 0;
                        )
                          b = b.nodes()[0].children().intersection(h);
                        var $ = 0,
                          Q = b.nodes(":childless")[0].connectedEdges().length;
                        (b.nodes(":childless").forEach(function (k, at) {
                          k.connectedEdges().length < Q &&
                            ((Q = k.connectedEdges().length), ($ = at));
                        }),
                        ...
                        T.forEach(function (F) {
                          ...
                          (F.isParent()
                            ...
                            F.neighborhood()
                              .nodes()
                              .forEach(function ($) {
                                h.intersection(F.edgesWith($)).length > 0 &&
                                  ($.isParent()
                                    ? M[b].push(S.get($.id()))
                                    : M[b].push($.id()));
                              }));
                      ...
                      try {
                        for (
                          var Tt = d.keys()[Symbol.iterator](), At;
                          !(vt = (At = Tt.next()).done);
                          vt = !0
                        ) {
                          var Dt = At.value;
                      ...
                      if (m > 2) {
                        ...
                        for (var xt = 0; xt < m; xt++) D[xt] = [];
                        for (var St = 0; St < R; St++) n[St] = [];
                        return (
                          o.quality == "draft" || o.step == "all"
                            ? (q(I),
                              V(),
                              U(),
                              (mt = { nodeIndexes: N, xCoords: P, yCoords: K }))
                            : (N.forEach(function (F, b) {
                                (P.push(c.getElementById(b).position("x")),
                                  K.push(c.getElementById(b).position("y")));
                              }),
                              (mt = {
                                nodeIndexes: N,
                                xCoords: P,
                        ...
                        var Vt = N.keys(),
                          Xt = c.getElementById(Vt.next().value),
                          Ut = Xt.position(),
                          bt = Xt.outerWidth();
                        if ((P.push(Ut.x), K.push(Ut.y), m == 2)) {
                          var Ht = c.getElementById(Vt.next().value),
                            Bt = Ht.outerWidth();
                          (P.push(Ut.x + bt / 2 + Bt / 2 + o.idealEdgeLength),
                            K.push(Ut.y));
                        }
                        return (
                          (mt = { nodeIndexes: N, xCoords: P, yCoords: K }),
...
var Tr = mr();
const Nr = ur(Tr);
var Se = { L: "left", R: "right", T: "top", B: "bottom" },
  Fe = {
    L: nt((C) => `${C},${C / 2} 0,${C} 0,0`, "L"),
    R: nt((C) => `0,${C / 2} ${C},0 ${C},${C}`, "R"),
    T: nt((C) => `0,0 ${C},0 ${C / 2},${C}`, "T"),
    B: nt((C) => `${C / 2},0 ${C},${C} 0,${C}`, "B"),
  },
  he = {
    L: nt((C, X) => C - X + 2, "L"),
    R: nt((C, X) => C - 2, "R"),
  ...
  me = nt(function (C, X) {
    const A = `${C}${X}`;
    return Mr(A) ? A : void 0;
  }, "getArchitectureDirectionPair"),
  Ar = nt(function ([C, X], A) {
    const G = A[0],
      L = A[1];
    return zt(G)
      ? Qt(L)
  ...
  Ue = nt((C) => C.data(), "edgeData"),
  ne = nt((C) => C.data(), "nodeData"),
  Ye = nr.architecture,
  pt = new cr(() => ({
    nodes: {},
    groups: {},
  ...
  Rr = nt(function ({ id: C, icon: X, in: A, title: G, iconText: L }) {
    ...
    ((pt.records.registeredIds[C] = "node"),
      (pt.records.nodes[C] = {
        id: C,
        type: "service",
        icon: X,
  ...
  Sr = nt(() => Object.values(pt.records.nodes).filter(Dr), "getServices"),
  Fr = nt(function ({ id: C, in: X }) {
    ((pt.records.registeredIds[C] = "node"),
      (pt.records.nodes[C] = { id: C, type: "junction", edges: [], in: X }));
  }, "addJunction"),
  br = nt(() => Object.values(pt.records.nodes).filter(xr), "getJunctions"),
  Pr = nt(() => Object.values(pt.records.nodes), "getNodes"),
  Te = nt((C) => pt.records.nodes[C], "getNode"),
  Gr = nt(function ({ id: C, icon: X, in: A, title: G }) {
    if (pt.records.registeredIds[C] !== void 0)
      throw new Error(
    ...
    ((pt.records.registeredIds[C] = "group"),
      (pt.records.groups[C] = { id: C, icon: X, title: G, in: A }));
  }, "addGroup"),
  Ur = nt(() => Object.values(pt.records.groups), "getGroups"),
  Yr = nt(function ({
    lhsId: C,
    rhsId: X,
    lhsDir: A,
    ...
    const e = pt.records.nodes[C].in,
      f = pt.records.nodes[X].in;
    if (l && e && f && e == f)
      throw new Error(
    ...
    (pt.records.edges.push(i),
      pt.records.nodes[C] &&
        pt.records.nodes[X] &&
        (pt.records.nodes[C].edges.push(
          pt.records.edges[pt.records.edges.length - 1],
        ),
        pt.records.nodes[X].edges.push(
          pt.records.edges[pt.records.edges.length - 1],
        )));
  }, "addEdge"),
  Xr = nt(() => pt.records.edges, "getEdges"),
  Hr = nt(() => {
    if (pt.records.dataStructures === void 0) {
      const C = {},
        X = Object.entries(pt.records.nodes).reduce(
          (a, [r, e]) => (
            (a[r] = e.edges.reduce((f, i) => {
              var s, o;
              const u = (s = Te(i.lhsId)) == null ? void 0 : s.in,
                t = (o = Te(i.rhsId)) == null ? void 0 : o.in;
              if (u && t && u !== t) {
                const c = Or(i.lhsDir, i.rhsDir);
                c !== "bend" &&
                  (C[u] ?? (C[u] = {}),
                  (C[u][t] = c),
                  C[t] ?? (C[t] = {}),
        ...
        l = [g(A)];
      for (; Object.keys(L).length > 0; ) l.push(g(Object.keys(L)[0]));
  ...
  Vr = nt((C) => pt.records.elements[C], "getElementById"),
  Xe = nt(() => ir({ ...Ye, ...ar().architecture }), "getConfig"),
  ge = {
    clear: Ir,
    setDiagramTitle: tr,
    getDiagramTitle: _e,
...
var zr = nt((C, X) => {
    (fr(C, X),
      C.groups.map(X.addGroup),
      C.services.map((A) => X.addService({ ...A, type: "service" })),
      C.junctions.map((A) => X.addJunction({ ...A, type: "junction" })),
      C.edges.map(X.addEdge));
  }, "populateDb"),
  Br = {
    parse: nt(async (C) => {
...
`,
  ...
  ae = nt(
    (C) =>
      `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${C}</g>`,
    "wrapIcon",
  ),
  oe = {
        ...
        if (
          ...
          o &&
            (zt(t)
              ...
              : (S += t === "T" ? -M : M + 18)),
          !i &&
            ((P = ge.getNode(r)) == null ? void 0 : P.type) === "junction" &&
            (zt(e) ? (h += e === "L" ? L : -L) : (T += e === "T" ? L : -L)),
          !o &&
            ((K = ge.getNode(u)) == null ? void 0 : K.type) === "junction" &&
            (zt(t) ? (N += t === "L" ? L : -L) : (S += t === "T" ? L : -L)),
          a[0]._private.rscratch)
        ) {
          const Y = C.insert("g");
          if (
            (Y.insert("path")
              .attr("d", `M ${h},${T} L ${v},${d} L${N},${S} `)
              .attr("class", "edge"),
            f)
          ) {
            const Z = zt(e) ? he[e](h, g) : h - l,
              D = Qt(e) ? he[e](T, g) : T - l;
            Y.insert("polygon")
              .attr("points", Fe[e](g))
              .attr("transform", `translate(${Z},${D})`)
              .attr("class", "arrow");
          }
          if (s) {
            const Z = zt(t) ? he[t](N, g) : N - l,
              D = Qt(t) ? he[t](S, g) : S - l;
            Y.insert("polygon")
              .attr("points", Fe[t](g))
              .attr("transform", `translate(${Z},${D})`)
          ...
          if (c) {
            ...
            if (
              ...
              rt.attr(
                "transform",
                "translate(" + v + ", " + d + ") rotate(-90)",
              );
            else if (Z === "XY") {
              const n = me(e, t);
              if (n && Cr(n)) {
                const m = rt.node().getBoundingClientRect(),
                  [p, E] = wr(n);
                rt.attr("dominant-baseline", "auto").attr(
                  "transform",
                  `rotate(${-1 * p * E * 45})`,
                );
  ...
  qr = nt(async function (C, X) {
    const G = Pt("padding") * 0.75,
      L = Pt("fontSize"),
      l = Pt("iconSize") / 2;
    await Promise.all(
      X.nodes().map(async (a) => {
      ...
      if (G.title) {
        ...
        (await Ne(
          ...
          e
            ...
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle"),
          e.attr("transform", "translate(" + g / 2 + ", " + g + ")"));
      }
      const l = L.append("g");
      if (G.icon)
        l.html(
          `<g>${await Ee(G.icon, { height: g, width: g, fallbackPrefix: oe.prefix })}</g>`,
        );
      else if (G.iconText) {
        l.html(
          `<g>${await Ee("blank", { height: g, width: g, fallbackPrefix: oe.prefix })}</g>`,
        );
        const i = l
            .append("g")
            ...
            .attr("style", `height: ${g}px;`)
            .append("div")
            .html(G.iconText),
          u =
            parseInt(
              window
                .getComputedStyle(i.node(), null)
        ...
        l.append("path")
          .attr("class", "node-bkg")
          .attr("id", "node-" + G.id)
          .attr("d", `M0 ${g} v${-g} q0,-5 5,-5 h${g} q5,0 5,5 v${g} H0 Z`);
...
function Ve(C, X) {
  X.nodes().map((A) => {
    ...
    ((G.x = A.position().x),
      (G.y = A.position().y),
      C.getElementById(G.id).attr(
        "transform",
        "translate(" + (G.x || 0) + "," + (G.y || 0) + ")",
      ));
  });
}
nt(Ve, "positionNodes");
...
function Be(C, X) {
  C.forEach((A) => {
    const {
      ...
      u = Ce(A.lhsDir, A.rhsDir) ? "segments" : "straight",
      t = {
        id: `${G}-${L}`,
        label: i,
        source: G,
  ...
  const G = nt(
    ...
    L = X.map((a) => {
      ...
      return (
        ...
        {
          horiz: Object.values(G(r, "horizontal")).filter((f) => f.length > 1),
          vert: Object.values(G(e, "vertical")).filter((f) => f.length > 1),
        }
      );
    }),
    [g, l] = L.reduce(
...
function ke(C) {
  const X = [],
    A = nt((L) => `${L[0]},${L[1]}`, "posToStr"),
    G = nt((L) => L.split(",").map((g) => parseInt(g)), "strToPos");
  return (
    C.forEach((L) => {
...
function Ze(C, X, A, G, L, { spatialMaps: g, groupAlignments: l }) {
  return new Promise((a) => {
    const r = sr("body")
      ...
      e = Ge({
        ...
        style: [
          ...
          { selector: ".node-group", style: { padding: `${Pt("padding")}px` } },
        ],
      });
    ...
    (u.one("layoutstop", () => {
      ...
      function t(o, c, h, T) {
        ...
        ((d =
          (T - S + ((N - h) * (S - P)) / (N - M)) /
          Math.sqrt(1 + Math.pow((S - P) / (N - M), 2))),
          (v = Math.sqrt(
            Math.pow(T - S, 2) + Math.pow(h - N, 2) - Math.pow(d, 2),
          )));
        const K = Math.sqrt(Math.pow(M - N, 2) + Math.pow(P - S, 2));
        v = v / K;
        let Y = (M - N) * (T - S) - (P - S) * (h - N);
        switch (!0) {
          case Y >= 0:
            Y = 1;
            break;
      ...
      for (const o of Object.values(e.edges()))
        if ((s = o.data) != null && s.call(o)) {
          const { x: c, y: h } = o.source().position(),
            { x: T, y: v } = o.target().position();
          if (c !== T && h !== v) {
            const d = o.sourceEndpoint(),
              N = o.targetEndpoint(),
              { sourceDir: S } = Ue(o),
              [M, P] = Qt(S) ? [d.x, N.y] : [N.x, d.y],
              { weights: K, distances: Y } = t(d, N, M, P);
...
var Kr = nt(async (C, X, A, G) => {
    const L = G.db,
      g = L.getServices(),
      l = L.getJunctions(),
      a = L.getGroups(),
      r = L.getEdges(),
      e = L.getDataStructures(),
      f = er(X),
      i = f.append("g");
    ...
    const t = f.append("g");
    (t.attr("class", "architecture-groups"), await Jr(L, u, g), Qr(L, u, l));
    const s = await Ze(g, l, a, r, L, e);
    (await Zr(i, s),
      await qr(t, s),
      Ve(L, s),
      rr(void 0, f, Pt("padding"), Pt("useMaxWidth")));
  }, "draw"),
  jr = { draw: Kr },
  hi = { parser: Br, db: ge, renderer: jr, styles: kr };
export { hi as diagram };
