...
var X = (function () {
  var n = s(function (f, i, a, h) {
    ...
    p = {
      ...
      performAction: s(function (i, a, h, u, y, o, S) {
        var k = o.length - 1;
        switch (y) {
          case 1:
            return o[k - 1];
          ...
          case 7:
            ...
            break;
          case 8:
            (u.getCommonDb().setDiagramTitle(o[k].substr(6)),
              (this.$ = o[k].substr(6)));
            break;
          case 9:
      ...
      parse: s(function (i) {
        ...
        for (var b in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, b) &&
            (E.yy[b] = this.yy[b]);
        (v.setInput(i, E.yy),
          (E.yy.lexer = v),
          (E.yy.parser = this),
        ...
        function F() {
          ...
          return (
            (I = u.pop() || v.lex() || J),
            typeof I != "number" &&
              (I instanceof Array && ((u = I), (I = u.pop())),
              (I = a.symbols_[I] || I)),
            I
          );
        }
          ...
          switch (N[0]) {
            ...
            case 2:
              ...
              (M &&
                ...
                (y = y.slice(0, -1 * M)),
                (o = o.slice(0, -1 * M))),
                h.push(this.productions_[N[1]][0]),
                y.push(V.$),
                o.push(V._$),
        ...
        unput: s(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: h
                ? (h.length === u.length ? this.yylloc.first_column : 0) +
                  u[u.length - h.length].length -
                  h[0].length
...
` +
        ...
        next: s(function () {
          ...
          for (var y = this._currentRules(), o = 0; o < y.length; o++)
            if (
              ((h = this._input.match(this.rules[y[o]])),
              h && (!a || h[0].length > a[0].length))
            ) {
              if (((a = h), (u = o), this.options.backtrack_lexer)) {
                if (((i = this.test_match(h, y[o])), i !== !1)) return i;
                if (this._backtrack) {
                  a = !1;
                  devconx;
                } else return !1;
          ...
          return a
            ? ((i = this.test_match(a, y[u])), i !== !1 ? i : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
var W = "",
  ...
  gt = s(function (n) {
    const t = { section: W, type: W, description: n, task: n, classes: [] };
    U.push(t);
  }, "addTaskOrg"),
  rt = s(function () {
    ...
    let t = !0;
    for (const [e, l] of z.entries()) (n(e), (t = t && l.processed));
    return t;
  }, "compileTasks"),
  It = {
    clear: ct,
  ...
  Lt = s(function (n, t) {
    ...
    return (
      s(g, "ambivalent"),
      t.score > 3 ? d(r) : t.score < 3 ? c(r) : g(r),
      l
    );
  }, "drawFace"),
  $t = s(function (n, t) {
  ...
  Pt = s(function (n, t, e) {
    ...
    (r
      ...
      .attr("stroke", "#666"),
      Lt(r, { cx: l, cy: 300 + (5 - t.score) * 30, score: t.score }));
    const c = D();
    ((c.x = t.x),
      (c.y = t.y),
      (c.fill = t.fill),
  ...
  mt = (function () {
    ...
    function t(r, d, c, g, m, p, x, _, f) {
      const { taskFontSize: i, taskFontFamily: a } = _,
        h = r.split(/<br\s*\/?>/gi);
      for (let u = 0; u < h.length; u++) {
        const y = u * i - (i * (h.length - 1)) / 2,
          o = d
            .append("text")
            .attr("x", c + m / 2)
            .attr("y", g)
    ...
    s(e, "byFo");
    function l(r, d) {
      for (const c in d) c in d && r.attr(c, d[c]);
    }
    return (
      s(l, "_setTextAttrs"),
      function (r) {
  ...
  n.each(function () {
    ...
    for (let x = 0; x < l.length; x++)
      ((r = l[l.length - 1 - x]),
        d.push(r),
        p.text(d.join(" ").trim()),
        (p.node().getComputedTextLength() > t || r === "<br>") &&
          (d.pop(),
          p.text(d.join(" ").trim()),
          r === "<br>" ? (d = [""]) : (d = [r]),
          (p = e
...
var Ft = s(function (n, t, e, l) {
    ...
    const c = d.append("g"),
      ...
      p = g
        ...
        .getBBox(),
      x =
        (_ = l.fontSize) != null && _.replace
          ? l.fontSize.replace("px", "")
          : l.fontSize;
    return (
  ...
  zt = s(function (n, t, e, l) {
    ...
    c === "sandbox" && (g = q("#i" + t));
    const p = (
      c === "sandbox" ? q(g.nodes()[0].contentDocument.body) : q("body")
    ).select("#" + t);
    p.append("g");
    ...
    for (const [E, b] of x.entries()) {
      ...
      (T.debug("taskHeight before draw", P),
        (a = Math.max(a, P + 20)),
        ($ = Math.max($, b.events.length)));
      let A = 0;
      ...
      (b.events.length > 0 && (A += (b.events.length - 1) * 10),
        (H = Math.max(H, A)));
    }
    (T.debug("maxSectionHeight before draw", i),
      T.debug("maxTaskHeight before draw", a),
      f && f.length > 0
        ? f.forEach((E) => {
            const b = x.filter((F) => F.section === E),
              L = {
                number: S,
                descr: E,
                section: S,
            ...
            const P = p.append("g"),
              A = R.drawNode(P, L, S, r);
            (T.debug("sectionNode output", A),
              P.attr("transform", `translate(${y}, ${u})`),
              (o += i + 50),
              b.length > 0 && st(p, b, S, y, o, a, r, $, H, i, !1),
              (y += 200 * Math.max(b.length, 1)),
              (o = u),
              S++);
          })
        : ((k = !1), st(p, x, S, y, o, a, r, $, H, i, !0)));
  ...
  st = s(function (n, t, e, l, r, d, c, g, m, p, x) {
    var _;
    for (const f of t) {
      const i = {
        descr: f.task,
      ...
      const a = n.append("g").attr("class", "taskWrapper"),
        u = R.drawNode(a, i, e, c).height;
      if (
        (T.debug("taskHeight after draw", u),
        a.attr("transform", `translate(${l}, ${r})`),
        (d = Math.max(d, u)),
        f.events)
      ) {
      ...
      ((l = l + 200),
        x && !((_ = c.timeline) != null && _.disableMulticolor) && e++);
    }
    r = r - 10;
  }, "drawTasks"),
  Bt = s(function (n, t, e, l, r, d) {
    let c = 0;
    const g = r;
    r = r + 100;
    for (const m of t) {
      ...
      ((c = c + f),
        x.attr("transform", `translate(${l}, ${r})`),
        (r = r + 10 + f));
    }
    return ((r = g), c);
  }, "drawEvents"),
  Ot = { setConf: s(() => {}, "setConf"), draw: zt },
  jt = s((n) => {
    let t = "";
