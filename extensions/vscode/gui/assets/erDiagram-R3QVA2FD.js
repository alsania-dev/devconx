import { g as Dt } from "./chunk-BFAMUDN2.js";
import { s as wt } from "./chunk-SKB7J2MH.js";
import {
  _ as u,
  b as Vt,
  a as Lt,
      ...
      performAction: u(function (n, a, c, r, p, t, K) {
        ...
        switch (p) {
          ...
          case 8:
            (r.addEntity(t[e - 4]),
              r.addEntity(t[e - 2]),
              r.addRelationship(t[e - 4], t[e], t[e - 2], t[e - 3]));
            break;
          case 9:
            (r.addEntity(t[e - 8]),
              r.addEntity(t[e - 4]),
          ...
          case 13:
            (r.addEntity(t[e - 5]),
              r.addAttributes(t[e - 5], t[e - 1]),
              r.setClass([t[e - 5]], t[e - 3]));
            break;
          case 14:
            r.addEntity(t[e - 2]);
            break;
          ...
          case 17:
            ...
            break;
          case 18:
            (r.addEntity(t[e - 6], t[e - 4]),
              r.addAttributes(t[e - 6], t[e - 1]));
            break;
          case 19:
            (r.addEntity(t[e - 8], t[e - 6]),
              r.addAttributes(t[e - 8], t[e - 1]),
              r.setClass([t[e - 8]], t[e - 3]));
            break;
          case 20:
      ...
      parse: u(function (n) {
        ...
        function Ot() {
          ...
          return (
            (b = r.pop() || y.lex() || Tt),
            typeof b != "number" &&
              (b instanceof Array && ((r = b), (b = r.pop())),
              (b = a.symbols_[b] || b)),
            b
          );
        }
          ...
          switch (m[0]) {
            ...
            case 2:
              if (
                ...
                (ht = this.performAction.apply(
                  C,
                  [e, St, H, x.yy, m[1], p, t].concat(It),
                )),
                typeof ht < "u")
              )
                return ht;
...
` +
        ...
        next: u(function () {
          ...
          for (var p = this._currentRules(), t = 0; t < p.length; t++)
            if (
              ((c = this._input.match(this.rules[p[t]])),
    ...
    ((w = class {
        ...
        return (
          this.entities.has(i)
            ? !((d = this.entities.get(i)) != null && d.alias) &&
              h &&
              ((this.entities.get(i).alias = h),
              D.info(`Add alias '${h}' to entity '${i}'`))
            : (this.entities.set(i, {
      ...
      getCompiledStyles(i) {
        ...
        for (const d of i) {
          ...
          (o != null &&
            o.styles &&
            (h = [...h, ...(o.styles ?? [])].map((l) => l.trim())),
            o != null &&
              o.textStyles &&
              (h = [...h, ...(o.textStyles ?? [])].map((l) => l.trim())));
        }
        return h;
      }
      addCssStyles(i, h) {
      ...
      addClass(i, h) {
        i.forEach((d) => {
          ...
          (o === void 0 &&
            ((o = { id: d, styles: [], textStyles: [] }),
            this.classes.set(d, o)),
            h &&
      ...
      getData() {
        ...
        for (const l of this.entities.keys()) {
          ...
          f &&
            ((f.cssCompiledStyles = this.getCompiledStyles(
              f.cssClasses.split(" "),
            )),
            i.push(f));
        }
...
var Ht = u(async function (s, i, h, d) {
    ...
    ((_.type = d.type),
      ...
      (_.config.flowchart.nodeSpacing =
        (l == null ? void 0 : l.nodeSpacing) || 140),
      (_.config.flowchart.rankSpacing =
        (l == null ? void 0 : l.rankSpacing) || 80),
