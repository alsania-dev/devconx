...
import { g as we } from "./XCircleIcon.js";
import { b as Zn, t as He, c as Xn, a as Gn, l as Qn } from "./linear.js";
import { i as $n } from "./init.js";
...
function on(t, e) {
  var n = [],
    ...
    s = 6,
    p = 3,
    M = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : 0.5,
    T = t === Xt || t === Zt ? -1 : 1,
    g = t === Zt || t === oe ? "x" : "y",
    U = t === Xt || t === ke ? tr : er;
  function C(b) {
    var X = r ?? (e.ticks ? e.ticks.apply(e, n) : e.domain()),
      H = i ?? (e.tickFormat ? e.tickFormat.apply(e, n) : Kn),
      D = Math.max(a, 0) + p,
      I = e.range(),
      V = +I[0] + M,
      W = +I[I.length - 1] + M,
      B = (e.bandwidth ? rr : nr)(e.copy(), M),
      $ = b.selection ? b.selection() : b,
      w = $.selectAll(".domain").data([null]),
      O = $.selectAll(".tick").data(X, e).order(),
      x = O.exit(),
      F = O.enter().append("g").attr("class", "tick"),
      S = O.select("line"),
      _ = O.select("text");
    ((w = w.merge(
      w
      ...
      (_ = _.merge(
        F.append("text")
          ...
          .attr(g, T * D)
          .attr("dy", t === Xt ? "0em" : t === ke ? "0.71em" : "0.32em"),
      )),
      b !== $ &&
        ((w = w.transition(b)),
        (O = O.transition(b)),
        ...
        (x = x
          ...
          .attr("transform", function (k) {
            return isFinite((k = B(k)))
              ? U(k + M)
              : this.getAttribute("transform");
          })),
        F.attr("opacity", Oe).attr("transform", function (k) {
      ...
      w.attr(
        ...
        t === Zt || t === oe
          ? s
            ? "M" + T * s + "," + V + "H" + M + "V" + W + "H" + T * s
            : "M" + M + "," + V + "V" + W
          : s
            ? "M" + V + "," + T * s + "V" + M + "H" + W + "V" + T * s
            : "M" + V + "," + M + "H" + W,
      ),
      O.attr("opacity", 1).attr("transform", function (k) {
        return U(B(k) + M);
      }),
      S.attr(g + "2", T * a),
      _.attr(g, T * D).text(H),
      $.filter(ir)
        ...
        .attr("text-anchor", t === oe ? "start" : t === Zt ? "end" : "middle"),
      $.each(function () {
        this.__axis = B;
      }));
  }
  return (
    ...
    (C.tickArguments = function (b) {
      return arguments.length
        ? ((n = b == null ? [] : Array.from(b)), C)
        : n.slice();
    }),
    (C.tickValues = function (b) {
      return arguments.length
        ? ((r = b == null ? null : Array.from(b)), C)
        : r && r.slice();
    }),
...
function dn(t) {
  ...
  var e = fe(t.r),
    n = fe(t.g),
    r = fe(t.b),
    i = ce((0.2225045 * e + 0.7168786 * n + 0.0606169 * r) / un),
    a,
    s;
  return (
    e === n && n === r
      ? (a = s = i)
      : ((a = ce((0.4360747 * e + 0.3850649 * n + 0.1430804 * r) / cn)),
        (s = ce((0.0139322 * e + 0.0971045 * n + 0.7141733 * r) / ln))),
    new ft(116 * i - 16, 500 * (a - i), 200 * (i - s), t.opacity)
  );
}
function lr(t, e, n, r) {
...
function fr(t) {
  ...
  if ((t instanceof ft || (t = dn(t)), t.a === 0 && t.b === 0))
...
function hr(t) {
  return function (e, n) {
    var r = t((e = pe(e)).h, (n = pe(n)).h),
      i = se(e.c, n.c),
      a = se(e.l, n.l),
      s = se(e.opacity, n.opacity);
    return function (p) {
      return (
        (e.h = r(p)),
        (e.c = i(p)),
...
function et(t, e, n, r) {
  ...
  return (
    ...
    (i.offset = (a, s) => (
      e((a = new Date(+a)), s == null ? 1 : Math.floor(s)),
      a
    )),
    (i.range = (a, s, p) => {
      const M = [];
      if (
        ((a = i.ceil(a)),
        (p = p == null ? 1 : Math.floor(p)),
        !(a < s) || !(p > 0))
      )
        return M;
      let T;
      do (M.push((T = new Date(+a))), e(a, p), t(a));
      while (T < a && a < s);
      return M;
    }),
    (i.filter = (a) =>
      et(
        ...
        (s, p) => {
          if (s >= s)
            if (p < 0) for (; ++p <= 0; ) for (; e(s, -1), !a(s); );
            else for (; --p >= 0; ) for (; e(s, 1), !a(s); );
        },
      )),
    n &&
      ((i.count = (a, s) => (
...
const Ht = et(
  (t) => {
    t.setTime(
      t - t.getMilliseconds() - t.getSeconds() * mt - t.getMinutes() * ct,
    );
  },
  (t, e) => {
    t.setTime(+t + e * gt);
...
function wt(t) {
  return et(
    ...
    (e, n) =>
      (n - e - (n.getTimezoneOffset() - e.getTimezoneOffset()) * ct) / Ce,
  );
}
const Vt = wt(0),
  Ot = wt(1),
...
function wr(t, e, n, r, i, a) {
  ...
  function p(T, g, U) {
    const C = g < T;
    C && ([T, g] = [g, T]);
    const b = U && typeof U.range == "function" ? U : M(T, g, U),
      X = b ? b.range(T, +g + 1) : [];
    return C ? X.reverse() : X;
  }
  function M(T, g, U) {
    const C = Math.abs(g - T) / U,
      b = Zn(([, , D]) => D).right(s, C);
    if (b === s.length) return t.every(He(T / me, g / me, U));
    if (b === 0) return Yt.every(Math.max(He(T, g, U), 1));
    const [X, H] = s[C / s[b - 1][2] < s[b][2] / C ? b - 1 : b];
    return X.every(H);
  }
  return [p, M];
}
const [Cr, Dr] = wr(kt, Nt, Vt, Tt, Ht, Wt);
function ge(t) {
  if (0 <= t.y && t.y < 100) {
    ...
    return function (N) {
      ...
      if (
        ...
        ("w" in f || (f.w = 1),
          "Z" in f
            ? ((L = ye(Lt(f.y, 0, 1))),
              ...
              (L = De.offset(L, (f.V - 1) * 7)),
              (f.y = L.getUTCFullYear()),
              (f.m = L.getUTCMonth()),
              (f.d = L.getUTCDate() + ((f.w + 6) % 7)))
            : ((L = ge(Lt(f.y, 0, 1))),
              (Q = L.getDay()),
              (L = Q > 4 || Q === 0 ? Ot.ceil(L) : Ot(L)),
        ...
        ("W" in f || "U" in f) &&
          ...
          (Q =
            "Z" in f
              ? ye(Lt(f.y, 0, 1)).getUTCDay()
              : ge(Lt(f.y, 0, 1)).getDay()),
          (f.m = 0),
          (f.d =
            "W" in f
              ? ((f.w + 6) % 7) + f.W * 7 - ((Q + 5) % 7)
              : f.w + f.U * 7 - ((Q + 6) % 7)));
      return "Z" in f
        ? ((f.H += (f.Z / 100) | 0), (f.M += f.Z % 100), ye(f))
        : ge(f);
    };
  }
  function x(v, A, N, f) {
    for (var J = 0, L = A.length, Q = N.length, Z, rt; J < L; ) {
      ...
      if (((Z = A.charCodeAt(J++)), Z === 37)) {
        if (
          ...
          return -1;
      } else if (Z != N.charCodeAt(f++)) return -1;
    }
    return f;
  }
  function F(v, A, N) {
...
function ri(t, e) {
  return q(Ot.count(kt(t) - 1, t), e, 2);
}
function ii(t, e) {
...
function oi(t, e) {
  var n = t.getDay();
  return (
    (t = n >= 4 || n === 0 ? bt(t) : bt.ceil(t)),
    q(t.getFullYear() % 1e4, e, 4)
  );
}
function ci(t) {
...
function fi(t, e) {
  return q(1 + De.count(xt(t), t), e, 3);
}
function xn(t, e) {
...
function Cn(t, e, n, r, i, a, s, p, M, T) {
  var g = Xn(),
    U = g.invert,
    C = g.domain,
    b = T(".%L"),
  ...
  return (
    ...
    (g.domain = function (w) {
      return arguments.length ? C(Array.from(w, Si)) : C().map(_i);
    }),
    (g.ticks = function (w) {
      var O = C();
    ...
    (g.nice = function (w) {
      ...
      return (
        (!w || typeof w.range != "function") &&
          (w = e(O[0], O[O.length - 1], w ?? 10)),
        w ? C(mr(O, w)) : g
      );
    }),
    (g.copy = function () {
      return Gn(g, Cn(t, e, n, r, i, a, s, p, M, T));
    }),
    g
  );
}
function Fi() {
  return $n.apply(
    Cn(Cr, Dr, kt, Nt, Vt, Tt, Ht, Wt, vt, ne).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
              ...
              (p.isoWeek = function (T) {
                ...
                var g,
                  ...
                  H =
                    ((g = this.isoWeekYear()),
                    (U = this.$u),
                    (C = (U ? a.utc : a)().year(g).startOf("year")),
                    (b = 4 - C.isoWeekday()),
                    C.isoWeekday() > 4 && (b += 7),
                    C.add(b, n));
        ...
        (function (n, r) {
          ...
          function H(D) {
            ...
            for (
              ...
              var w = W[$],
                ...
                x = O && O[0],
                F = O && O[1];
              W[$] = F ? { regex: x, parser: F } : w.replace(/^\[|\]$/g, "");
            }
            return function (S) {
              ...
              return (
                (function (c) {
                  ...
                  if (u !== void 0) {
                    var o = c.hours;
                    (u ? o < 12 && (c.hours += 12) : o === 12 && (c.hours = 0),
                      delete c.afternoon);
                  }
                })(_),
                _
          ...
          return function (D, I, V) {
            ((V.p.customParseFormat = !0),
              D && D.parseTwoDigitYear && (T = D.parseTwoDigitYear));
            var W = I.prototype,
              B = W.parse;
            W.parse = function ($) {
              var w = $.date,
              ...
              if (typeof F == "string") {
                ...
                (_ && (Y = x[2]),
                  ...
                  (this.$d = (function (m, E, c, u) {
                    try {
                      ...
                      return v
                        ...
                        : c
                          ? new Date(Date.UTC(J, L, f, Z, rt, st, pt))
                  ...
                  k && w != this.format(F) && (this.$d = new Date("")),
                  (M = {}));
              } else if (F instanceof Array)
                for (var l = F.length, h = 1; h <= l; h += 1) {
                  x[1] = F[h - 1];
        ...
        (function (n, r) {
          ...
          return function (n, r) {
            ...
            i.format = function (s) {
              ...
              var T = this.$utils(),
                g = (s || "YYYY-MM-DDTHH:mm:ssZ").replace(
...
const Pi = we(Vi);
var ve = (function () {
  var t = d(function (Y, l, h, y) {
      for (h = h || {}, y = Y.length; y--; h[Y[y]] = l);
      return h;
    }, "o"),
    e = [
    ...
    S = {
      ...
      performAction: d(function (l, h, y, m, E, c, u) {
        var o = c.length - 1;
        switch (E) {
          case 1:
            return c[o - 1];
          ...
          case 36:
            ((this.$ = c[o - 2]),
              m.setClickEvent(c[o - 2], c[o - 1], null),
              m.setLink(c[o - 2], c[o]));
            break;
          case 37:
            ((this.$ = c[o - 3]),
              m.setClickEvent(c[o - 3], c[o - 2], c[o - 1]),
              m.setLink(c[o - 3], c[o]));
            break;
          case 38:
            ((this.$ = c[o - 2]),
              m.setClickEvent(c[o - 2], c[o], null),
              m.setLink(c[o - 2], c[o - 1]));
            break;
          case 39:
            ((this.$ = c[o - 3]),
              m.setClickEvent(c[o - 3], c[o - 1], c[o]),
              m.setLink(c[o - 3], c[o - 2]));
            break;
          case 40:
      ...
      parse: d(function (l) {
        ...
        function f(ot) {
          ((y.length = y.length - 2 * ot),
            (E.length = E.length - ot),
        ...
        function J() {
          ...
          return (
            (ot = m.pop() || j.lex() || K),
            typeof ot != "number" &&
              (ot instanceof Array && ((m = ot), (ot = m.pop())),
              (ot = h.symbols_[ot] || ot)),
            ot
          );
        }
...
Expecting ` +
          ...
          switch (Z[0]) {
            ...
            case 2:
              ...
              (ut &&
                ...
                (E = E.slice(0, -1 * ut)),
                (c = c.slice(0, -1 * ut))),
                y.push(this.productions_[Z[1]][0]),
                E.push(st.$),
                c.push(st._$),
                (We = u[y[y.length - 2]][y[y.length - 1]]),
                y.push(We));
              break;
            case 3:
              return !0;
    ...
    _ = (function () {
      var Y = {
        EOF: 1,
        parseError: d(function (h, y) {
          if (this.yy.parser) this.yy.parser.parseError(h, y);
          else throw new Error(h);
        }, "parseError"),
        setInput: d(function (l, h) {
          return (
            (this.yy = h || this.yy || {}),
            (this._input = l),
        ...
        unput: d(function (l) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: y
                ? (y.length === m.length ? this.yylloc.first_column : 0) +
                  m[m.length - y.length].length -
                  y[0].length
                : this.yylloc.first_column - h,
            }),
            this.options.ranges &&
              (this.yylloc.range = [E[0], E[0] + this.yyleng - h]),
...
` +
        ...
        pastInput: d(function () {
          ...
          return (
            (l.length > 20 ? "..." : "") + l.substr(-20).replace(/\n/g, "")
          );
        }, "pastInput"),
...
` +
        ...
        next: d(function () {
          ...
          for (var E = this._currentRules(), c = 0; c < E.length; c++)
            if (
              ((y = this._input.match(this.rules[E[c]])),
              y && (!h || y[0].length > h[0].length))
            ) {
              if (((h = y), (m = c), this.options.backtrack_lexer)) {
                if (((l = this.test_match(y, E[c])), l !== !1)) return l;
                if (this._backtrack) {
                  h = !1;
                  devconx;
                } else return !1;
          ...
          return h
            ? ((l = this.test_match(h, E[m])), l !== !1 ? l : !1)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: d(function (h, y, m, E) {
          switch (m) {
            case 0:
...
var Ke = { friday: 5, saturday: 6 },
  ...
  Et = "",
  Ue = "",
  Dn = ["active", "done", "crit", "milestone", "vert"],
  Ee = [],
  Rt = !1,
  Le = !1,
  Ae = "sunday",
  ...
  Mn = d(function (t, e, n, r) {
    return r.includes(t.format(e.trim()))
      ? !1
      : (n.includes("weekends") &&
            (t.isoWeekday() === Ke[ie] || t.isoWeekday() === Ke[ie] + 1)) ||
  ...
  Fn = d(function (t, e, n, r = !1) {
    ...
    let s = it(n, e.trim(), !0);
    if (s.isValid()) return (r && (s = s.add(1, "d")), s.toDate());
    let p = it(t);
    const [M, T] = Sn(n);
    if (!Number.isNaN(M)) {
      const g = p.add(M, T);
  ...
  ya = d(function (t, e) {
    ...
    return (
      a &&
        ((i.endTime = Fn(i.startTime, lt, a, Rt)),
        (i.manualEndTime = it(a, "YYYY-MM-DD", !0).isValid()),
        _n(i, lt, zt, Pt)),
      i
    );
  }, "compileData"),
  ...
  tn = d(function () {
    const t = d(function (n) {
      ...
      switch (tt[n].raw.startTime.type) {
        ...
        case "getStartDate":
          ((i = be(void 0, lt, tt[n].raw.startTime.startData)),
            i && (tt[n].startTime = i));
          break;
      }
      return (
  ...
  Ta = d(function (t, e) {
    let n = e;
    (_t().securityLevel !== "loose" && (n = Rn.sanitizeUrl(e)),
...
var Da = d(function () {
  ...
  Ma = d((t, e) => {
    let n = [...t].map(() => -1 / 0),
      r = [...t].sort((a, s) => a.startTime - s.startTime || a.order - s.order),
      i = 0;
    for (const a of r)
  ...
  ht,
  _a = d(function (t, e, n, r) {
    const i = _t().gantt,
      a = _t().securityLevel;
    let s;
    a === "sandbox" && (s = Bt("#i" + e));
    const p =
        a === "sandbox" ? Bt(s.nodes()[0].contentDocument.body) : Bt("body"),
      M = a === "sandbox" ? s.nodes()[0].contentDocument : document,
      T = M.getElementById(e);
    ((ht = T.parentElement.offsetWidth),
      ht === void 0 && (ht = 1200),
      i.useWidth !== void 0 && (ht = i.useWidth));
    const g = r.db.getTasks();
    let U = [];
    for (const x of g) U.push(x.type);
    U = O(U);
    const C = {};
    ...
    if (r.db.getDisplayMode() === "compact" || i.displayMode === "compact") {
      ...
      for (const x of U) C[x] = g.filter((F) => F.type === x).length;
    }
    T.setAttribute("viewBox", "0 0 " + ht + " " + b);
    const X = p.select(`[id="${e}"]`),
      H = Fi()
        .domain([
          Jn(g, function (x) {
            return x.startTime;
    ...
    function I(x, F, S) {
      const _ = i.barHeight,
        ...
        h = Qn()
          ...
          .range(["#00B9FA", "#F95002"])
          .interpolate(dr);
      (W(k, Y, l, F, S, x, r.db.getExcludes(), r.db.getIncludes()),
        B(l, Y, F, S),
        V(x, k, Y, l, _, h, F),
        $(k, Y),
        w(l, Y, F, S));
    ...
    d(I, "makeGantt");
    function V(x, F, S, _, k, Y, l) {
      x.sort((u, o) => (u.vert === o.vert ? 0 : u.vert ? 1 : -1));
      const y = [...new Set(x.map((u) => u.order))].map((u) =>
        x.find((o) => o.order === u),
      );
      X.append("g")
        .selectAll("rect")
        ...
        .attr("x", 0)
        .attr("y", function (u, o) {
          return ((o = u.order), o * F + S - 2);
        })
        .attr("width", function () {
          return l - i.rightPadding / 2;
        })
        .attr("height", F)
        ...
        .enter();
      const m = X.append("g").selectAll("rect").data(x).enter(),
        E = r.db.getLinks();
      if (
        (m
          .append("rect")
          ...
          .attr("x", function (u) {
            return u.milestone
              ? H(u.startTime) +
                  _ +
                  0.5 * (H(u.endTime) - H(u.startTime)) -
                  0.5 * k
              : H(u.startTime) + _;
          })
          .attr("y", function (u, o) {
            return ((o = u.order), u.vert ? i.gridLineStartPadding : o * F + S);
          })
          .attr("width", function (u) {
            return u.milestone
              ...
              : u.vert
                ? 0.08 * k
                : H(u.renderEndTime || u.endTime) - H(u.startTime);
          })
          .attr("height", function (u) {
            return u.vert
              ? g.length * (i.barHeight + i.barGap) + i.barHeight * 2
              : k;
          })
          ...
          .attr("class", function (u) {
            ...
            for (const [K, G] of U.entries())
              u.type === G && (P = K % i.numberSectionStyles);
            let z = "";
            return (
              u.active
                ? u.crit
        ...
        m
          ...
          .attr("x", function (u) {
            let o = H(u.startTime),
              R = H(u.renderEndTime || u.endTime);
            if (
              (u.milestone &&
                ((o += 0.5 * (H(u.endTime) - H(u.startTime)) - 0.5 * k),
                (R = o + k)),
              u.vert)
            )
              return H(u.startTime) + _;
            const P = this.getBBox().width;
            return P > R - o
              ? R + P + 1.5 * i.leftPadding > l
                ? o + _ - 5
                : R + _ + 5
              : (R - o) / 2 + o + _;
          })
          .attr("y", function (u, o) {
            return u.vert
              ? i.gridLineStartPadding +
                  g.length * (i.barHeight + i.barGap) +
                  60
              : ((o = u.order),
                o * F + i.barHeight / 2 + (i.fontSize / 2 - 2) + S);
          })
          .attr("text-height", k)
          .attr("class", function (u) {
            const o = H(u.startTime);
            let R = H(u.endTime);
            u.milestone && (R = o + k);
            const P = this.getBBox().width;
            let z = "";
            ...
            let K = 0;
            for (const [j, at] of U.entries())
              u.type === at && (K = j % i.numberSectionStyles);
            let G = "";
            return (
              u.active &&
                (u.crit ? (G = "activeCritText" + K) : (G = "activeText" + K)),
              u.done
                ? u.crit
                  ? (G = G + " doneCritText" + K)
                  : (G = G + " doneText" + K)
                : u.crit && (G = G + " critText" + K),
              u.milestone && (G += " milestoneText"),
              u.vert && (G += " vertText"),
              P > R - o
                ? R + P + 1.5 * i.leftPadding > l
                  ? z + " taskTextOutsideLeft taskTextOutside" + K + " " + G
                  : z +
                    ...
                    " width-" +
                    P
                : z + " taskText taskText" + K + " " + G + " width-" + P
            );
          }),
        ...
        m.filter(function (R) {
          ...
          var P = o.querySelector("#" + R.id),
            z = o.querySelector("#" + R.id + "-text");
          const K = P.parentNode;
          var G = o.createElement("a");
          (G.setAttribute("xlink:href", E.get(R.id)),
    ...
    d(V, "drawRects");
    function W(x, F, S, _, k, Y, l, h) {
      if (l.length === 0 && h.length === 0) return;
      let y, m;
      for (const { startTime: P, endTime: z } of Y)
        ((y === void 0 || P < y) && (y = P),
          (m === void 0 || z > m) && (m = z));
      if (!y || !m) return;
      ...
      const E = r.db.getDateFormat(),
        c = [];
      let u = null,
        o = it(y);
      for (; o.valueOf() <= m; )
        (r.db.isInvalidDate(o, E, l, h)
          ? u
            ? (u.end = o)
            : (u = { start: o, end: o })
          : u && (c.push(u), (u = null)),
      ...
      X.append("g")
        ...
        .attr("width", function (P) {
          const z = P.end.add(1, "day");
          return H(z) - H(P.start);
        })
        .attr("height", k - F - i.gridLineStartPadding)
        .attr("transform-origin", function (P, z) {
          return (
            (H(P.start) + S + 0.5 * (H(P.end) - H(P.start))).toString() +
            "px " +
            (z * x + 0.5 * k).toString() +
            "px"
          );
    ...
    function B(x, F, S, _) {
      let k = sr(H)
        .tickSize(-_ + F + i.gridLineStartPadding)
        .tickFormat(ne(r.db.getAxisFormat() || i.axisFormat || "%Y-%m-%d"));
      const l =
      ...
      if (
        (X.append("g")
          .attr("class", "grid")
          .attr("transform", "translate(" + x + ", " + (_ - 50) + ")")
          .call(k)
          .selectAll("text")
    ...
    function $(x, F) {
      ...
      X.append("g")
        ...
        .enter()
        .append(function (k) {
          const Y = k[0].split(zn.lineBreakRegex),
            l = -(Y.length - 1) / 2,
            h = M.createElementNS("http://www.w3.org/2000/svg", "text");
    ...
    function w(x, F, S, _) {
      ...
      if (k === "off") return;
      const Y = X.append("g").attr("class", "today"),
        l = new Date(),
        h = Y.append("line");
      (h
        .attr("x1", H(l) + x)
        ...
        .attr("y2", _ - i.titleTopMargin)
        .attr("class", "today"),
        k !== "" && h.attr("style", k.replace(/,/g, ";")));
    }
    d(w, "drawToday");
    function O(x) {
      const F = {},
      ...
      for (let _ = 0, k = x.length; _ < k; ++_)
        Object.prototype.hasOwnProperty.call(F, x[_]) ||
          ((F[x[_]] = !0), S.push(x[_]));
      return S;
    }
    d(O, "checkUnique");
  }, "draw"),
  Sa = { setConf: Da, draw: _a },
  Fa = d(
    (t) => `
  .mermaid-main-font {
...
`,
  ...
  Ya = Fa,
  Wa = { parser: zi, db: Ca, renderer: Sa, styles: Ya };
