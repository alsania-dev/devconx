import { g as Se, d as De } from "./chunk-67H74DCK.js";
import {
  _ as g,
  s as Pe,
  g as Be,
      ...
      performAction: g(function (x, m, v, b, R, h, Dt) {
        ...
        switch (R) {
          ...
          case 19:
            ...
            break;
          case 20:
            (b.setAccDescription(h[p].substring(15)),
              (this.$ = h[p].substring(15)));
            break;
          case 21:
          ...
          case 23:
            ...
            break;
          case 28:
            (h[p].splice(2, 0, "ENTERPRISE"),
              b.addPersonOrSystemBoundary(...h[p]),
              (this.$ = h[p]));
            break;
          case 29:
            (h[p].splice(2, 0, "SYSTEM"),
              b.addPersonOrSystemBoundary(...h[p]),
              (this.$ = h[p]));
            break;
          case 30:
            ...
            break;
          case 31:
            (h[p].splice(2, 0, "CONTAINER"),
              b.addContainerBoundary(...h[p]),
              (this.$ = h[p]));
            break;
          case 32:
          ...
          case 44:
            ...
            break;
          case 45:
            (b.addPersonOrSystem("external_system_db", ...h[p]),
              (this.$ = h[p]));
            break;
          case 46:
            (b.addPersonOrSystem("external_system_queue", ...h[p]),
              (this.$ = h[p]));
            break;
          case 47:
          ...
          case 51:
            ...
            break;
          case 52:
            (b.addContainer("external_container_queue", ...h[p]),
              (this.$ = h[p]));
            break;
          case 53:
          ...
          case 57:
            ...
            break;
          case 58:
            (b.addComponent("external_component_queue", ...h[p]),
              (this.$ = h[p]));
            break;
          case 60:
          ...
          case 69:
            ...
            break;
          case 70:
            (b.updateLayoutConfig("update_layout_config", ...h[p]),
              (this.$ = h[p]));
            break;
          case 71:
            this.$ = [h[p]];
      ...
      parse: g(function (x) {
        ...
        function he() {
          ...
          return (
            (L = b.pop() || D.lex() || ce),
            typeof L != "number" &&
              (L instanceof Array && ((b = L), (L = b.pop())),
              (L = m.symbols_[L] || L)),
            L
          );
        }
          ...
          switch (N[0]) {
            ...
            case 2:
              if (
                ...
                (Jt = this.performAction.apply(
                  wt,
                  [p, oe, Et, kt.yy, N[1], R, h].concat(Te),
                )),
                typeof Jt < "u")
              )
                return Jt;
      ...
      var _t = {
        ...
        unput: g(function (x) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [R[0], R[0] + this.yyleng - m]),
...
` +
        ...
        next: g(function () {
          ...
          for (var R = this._currentRules(), h = 0; h < R.length; h++)
            if (
              ((v = this._input.match(this.rules[R[h]])),
...
var Ue = Ft,
    ...
    for (let a of t) {
      ...
      if (l === 0) {
        ...
        (y.attr("x1", a.startPoint.x),
          ...
          y.style("fill", "none"),
          a.type !== "rel_b" &&
            y.attr("marker-end", "url(" + d + "#arrowhead)"),
          (a.type === "birel" || a.type === "rel_b") &&
            y.attr("marker-start", "url(" + d + "#arrowend)"),
          (l = -1));
      } else {
        let y = o.append("path");
        (y
          ...
          .attr(
            ...
            "Mstartx,starty Qcontrolx,controly stopx,stopy "
              ...
              .replaceAll(
                "controly",
                a.startPoint.y + (a.endPoint.y - a.startPoint.y) / 2,
              )
  ...
  b0 = g(function (e, t, s) {
    ...
    let o = t.bgColor ? t.bgColor : s[t.typeC4Shape.text + "_bg_color"],
      l = t.borderColor
        ? t.borderColor
        : s[t.typeC4Shape.text + "_border_color"],
    ...
    ((Ot = class {
      ...
      insert(t) {
        ...
        let s =
          ...
          a = l + t.height;
        ((s >= this.data.widthLimit ||
          o >= this.data.widthLimit ||
          this.nextData.cnt > ve) &&
      ...
      e.fontFamily &&
        (_.personFontFamily =
          ...
          _.messageFontFamily =
            e.fontFamily),
      e.fontSize &&
        (_.personFontSize = _.systemFontSize = _.messageFontSize = e.fontSize),
      e.fontWeight &&
        (_.personFontWeight =
          _.systemFontWeight =
          _.messageFontWeight =
...
var ke = g(function (e, t, s) {
  ...
  R0 = g(function (e, t, s, o) {
    ...
    for (let a of t) {
      ...
      let r = a.wrap && _.wrap,
        n = T0(_);
      o.db.getC4Type() === "C4Dynamic" &&
        (a.label.text = l + ": " + a.label.text);
      let u = Tt(a.label.text, n);
      (j("label", a, r, n, u),
        a.techn &&
          a.techn.text !== "" &&
          ((u = Tt(a.techn.text, n)), j("techn", a, r, n, u)),
        a.descr &&
          a.descr.text !== "" &&
          ((u = Tt(a.descr.text, n)), j("descr", a, r, n, u)));
      let d = s(a.from),
        f = s(a.to),
        y = O0(d, f);
...
function se(e, t, s, o, l) {
  ...
  for (let [r, n] of o.entries()) {
    ...
    if (
      ...
      let O = Ut(_);
      (j("type", n, u, O, a.data.widthLimit),
        (n.type.Y = i + 5),
        (i = n.type.Y + n.type.height));
    }
...
var S0 = g(function (e, t, s, o) {
    ...
    l === "sandbox" && (a = jt("#i" + t));
    const r =
      l === "sandbox" ? jt(a.nodes()[0].contentDocument.body) : jt("body");
    let n = o.db;
    (o.db.setWrap(_.wrap),
