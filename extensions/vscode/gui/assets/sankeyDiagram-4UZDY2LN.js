...
function Bt() {
  ...
  ((b.update = function (n) {
    ...
    (b.nodeId = function (n) {
      return arguments.length
        ? ((_ = typeof n == "function" ? n : X(n)), b)
        : _;
    }),
    (b.nodeAlign = function (n) {
      return arguments.length
        ? ((s = typeof n == "function" ? n : X(n)), b)
        : s;
    }),
    ...
    (b.nodes = function (n) {
      return arguments.length
        ? ((x = typeof n == "function" ? n : X(n)), b)
        : x;
    }),
    (b.links = function (n) {
      return arguments.length
        ? ((v = typeof n == "function" ? n : X(n)), b)
        : v;
    }),
  ...
  function T({ nodes: n }) {
    for (const f of n)
      f.value =
        f.fixedValue === void 0
          ? Math.max(nt(f.sourceLinks, it), nt(f.targetLinks, it))
          : f.fixedValue;
  }
  function N({ nodes: n }) {
    const f = n.length;
...
ot.prototype = kt.prototype = {
  ...
  arc: function (t, e, i, a, h, d) {
    ...
    (this._x1 === null
      ? (this._ += "M" + s + "," + o)
      : (Math.abs(this._x1 - s) > F || Math.abs(this._y1 - o) > F) &&
        (this._ += "L" + s + "," + o),
      i &&
        (x < 0 && (x = (x % rt) + rt),
        x > Rt
...
function Yt(t) {
  ...
  function m() {
    ...
    if (
      ...
      t(
        d,
        +a.apply(this, ((s[0] = o), s)),
        +h.apply(this, s),
        +a.apply(this, ((s[0] = l), s)),
        +h.apply(this, s),
      ),
      _)
    )
  ...
  return (
    ...
    (m.x = function (_) {
      return arguments.length
        ? ((a = typeof _ == "function" ? _ : dt(+_)), m)
        : a;
    }),
    (m.y = function (_) {
      return arguments.length
        ? ((h = typeof _ == "function" ? _ : dt(+_)), m)
        : h;
    }),
      ...
      parse: p(function (s) {
        ...
        function E() {
          ...
          return (
            (L = x.pop() || S.lex() || D),
            typeof L != "number" &&
              (L instanceof Array && ((x = L), (L = x.pop())),
              (L = o.symbols_[L] || L)),
            L
          );
        }
        ...
        unput: p(function (s) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === x.length ? this.yylloc.first_column : 0) +
                  x[x.length - l.length].length -
                  l[0].length
                : this.yylloc.first_column - o,
            }),
            this.options.ranges &&
              (this.yylloc.range = [v[0], v[0] + this.yyleng - o]),
...
` +
        ...
        next: p(function () {
          ...
          for (var v = this._currentRules(), y = 0; y < v.length; y++)
            if (
              ((l = this._input.match(this.rules[v[y]])),
              l && (!o || l[0].length > o[0].length))
            ) {
...
` +
        ...
        topState: p(function (o) {
          return (
            ...
            o >= 0 ? this.conditionStack[o] : "INITIAL"
          );
        }, "topState"),
...
var K = at,
  ...
  le = p(function (t, e, i, a) {
    ...
    h === "sandbox" && (_ = H("#i" + e));
    const s =
        h === "sandbox" ? H(_.nodes()[0].contentDocument.body) : H("body"),
