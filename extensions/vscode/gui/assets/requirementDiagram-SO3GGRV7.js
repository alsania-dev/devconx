import { g as Ge } from "./chunk-BFAMUDN2.js";
import { s as ze } from "./chunk-SKB7J2MH.js";
import {
  _ as m,
  b as Xe,
  a as Je,
      ...
      performAction: m(function (i, r, l, s, d, t, Ee) {
        ...
        switch (d) {
          ...
          case 21:
            ...
            break;
          case 22:
            (s.addRequirement(t[n - 5], t[n - 6]),
              s.setClass([t[n - 5]], t[n - 3]));
            break;
          case 23:
            s.setNewReqId(t[n - 2]);
            break;
      ...
      parse: m(function (i) {
        ...
        function Ue() {
          ...
          return (
            (T = s.pop() || S.lex() || $e),
            typeof T != "number" &&
              (T instanceof Array && ((s = T), (T = s.pop())),
              (T = r.symbols_[T] || T)),
            T
          );
        }
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(
                  J,
                  [n, Pe, ye, G.yy, q[1], d, t].concat(Ke),
                )),
                typeof Te < "u")
              )
                return Te;
        ...
        unput: m(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: l
                ? (l.length === s.length ? this.yylloc.first_column : 0) +
                  s[s.length - l.length].length -
                  l[0].length
                : this.yylloc.first_column - r,
            }),
            this.options.ranges &&
              (this.yylloc.range = [d[0], d[0] + this.yyleng - r]),
...
` +
        ...
        next: m(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (
              ((l = this._input.match(this.rules[d[t]])),
              l && (!r || l[0].length > r[0].length))
            ) {
    ...
    ((Z = class {
      ...
      setNewReqId(a) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.requirementId = a);
      }
      setNewReqText(a) {
      ...
      setNewReqVerifyMethod(a) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.verifyMethod = a);
      }
      addElement(a) {
        return (
          this.elements.has(a) ||
      ...
      defineClass(a, u) {
        for (const o of a) {
          ...
          (f === void 0 &&
            ((f = { id: o, styles: [], textStyles: [] }),
            this.classes.set(o, f)),
            u &&
            ...
            this.requirements.forEach((c) => {
              c.classes.includes(o) &&
                c.cssStyles.push(...u.flatMap((p) => p.split(",")));
            }),
        ...
        for (const h of this.relations) {
          ...
          const I = h.type === this.Relationships.CONTAINS,
            k = {
              id: `${h.src}-${h.dst}-${E}`,
              start:
                ((f = this.requirements.get(h.src)) == null
                  ? void 0
                  : f.name) ??
                ((c = this.elements.get(h.src)) == null ? void 0 : c.name),
              end:
                ((p = this.requirements.get(h.dst)) == null
                  ? void 0
                  : p.name) ??
