      ...
      parse: o(function (r) {
        ...
        function $t() {
          ...
          return (
            (B = f.pop() || E.lex() || Jt),
            typeof B != "number" &&
              (B instanceof Array && ((f = B), (B = f.pop())),
              (B = l.symbols_[B] || B)),
            B
          );
        }
            ...
            case 2:
              if (
                ...
                (Et = this.performAction.apply(
                  lt,
                  [s, Zt, mt, K.yy, N[1], _, e].concat(me),
                )),
                typeof Et < "u")
              )
                return Et;
        ...
        unput: o(function (r) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: g
                ? (g.length === f.length ? this.yylloc.first_column : 0) +
                  f[f.length - g.length].length -
                  g[0].length
                : this.yylloc.first_column - l,
            }),
            this.options.ranges &&
              (this.yylloc.range = [_[0], _[0] + this.yyleng - l]),
...
` +
        ...
        next: o(function () {
          ...
          for (var _ = this._currentRules(), e = 0; e < _.length; e++)
            if (
              ((g = this._input.match(this.rules[_[e]])),
              g && (!l || g[0].length > l[0].length))
            ) {
...
var De = Vt,
    ...
    ((ht = class {
      ...
      getDefaultConfig() {
        ...
        return {
          ...
          showTitle: !0,
          chartHeight:
            ((n = D.quadrantChart) == null ? void 0 : n.chartWidth) || 500,
          chartWidth:
            ((u = D.quadrantChart) == null ? void 0 : u.chartHeight) || 500,
          titlePadding:
            ((c = D.quadrantChart) == null ? void 0 : c.titlePadding) || 10,
          titleFontSize:
            ((h = D.quadrantChart) == null ? void 0 : h.titleFontSize) || 20,
          quadrantPadding:
            ((p = D.quadrantChart) == null ? void 0 : p.quadrantPadding) || 5,
          xAxisLabelPadding:
            ((y = D.quadrantChart) == null ? void 0 : y.xAxisLabelPadding) || 5,
          yAxisLabelPadding:
            ((S = D.quadrantChart) == null ? void 0 : S.yAxisLabelPadding) || 5,
          xAxisLabelFontSize:
            ((a = D.quadrantChart) == null ? void 0 : a.xAxisLabelFontSize) ||
            16,
          yAxisLabelFontSize:
            ((A = D.quadrantChart) == null ? void 0 : A.yAxisLabelFontSize) ||
            16,
          quadrantLabelFontSize:
            ((d = D.quadrantChart) == null
              ? void 0
              : d.quadrantLabelFontSize) || 16,
          quadrantTextTopPadding:
            ((T = D.quadrantChart) == null
              ? void 0
              : T.quadrantTextTopPadding) || 5,
          pointTextPadding:
            ((q = D.quadrantChart) == null ? void 0 : q.pointTextPadding) || 5,
          pointLabelFontSize:
            ((m = D.quadrantChart) == null ? void 0 : m.pointLabelFontSize) ||
            12,
          pointRadius:
            ((b = D.quadrantChart) == null ? void 0 : b.pointRadius) || 5,
          xAxisPosition:
            ((x = D.quadrantChart) == null ? void 0 : x.xAxisPosition) || "top",
          yAxisPosition:
            ((O = D.quadrantChart) == null ? void 0 : O.yAxisPosition) ||
            "left",
          quadrantInternalBorderStrokeWidth:
            ((Y = D.quadrantChart) == null
              ? void 0
              : Y.quadrantInternalBorderStrokeWidth) || 1,
          quadrantExternalBorderStrokeWidth:
            ((G = D.quadrantChart) == null
              ? void 0
              : G.quadrantExternalBorderStrokeWidth) || 2,
        };
      }
      ...
      setConfig(n) {
        (At.trace("setConfig called with: ", n),
          (this.config = { ...this.config, ...n }));
      }
      setThemeConfig(n) {
        (At.trace("setThemeConfig called with: ", n),
          (this.themeConfig = { ...this.themeConfig, ...n }));
      }
        ...
        for (const a of S)
          ((a.text.x = a.x + a.width / 2),
            this.data.points.length === 0
              ? ((a.text.y = a.y + a.height / 2),
                (a.text.horizontalPos = "middle"))
              : ((a.text.y = a.y + this.config.quadrantTextTopPadding),
                (a.text.horizontalPos = "top")));
        return S;
      }
      getQuadrantPoints(n) {
        const { quadrantSpace: u } = n,
  ...
  _t =
    ((ct = class extends Error {
      constructor(n, u, c) {
        (super(`value for ${n} ${u} is invalid, please use a valid ${c}`),
...
` + t,
    ...
    a === "sandbox" && (A = zt("#i" + n));
    const T = (
        a === "sandbox" ? zt(A.nodes()[0].contentDocument.body) : zt("body")
      ).select(`[id="${n}"]`),
    ...
    (ve(
      ...
      b,
      m,
      ((gt = S.quadrantChart) == null ? void 0 : gt.useMaxWidth) ?? !0,
    ),
    ...
    const dt = O.selectAll("g.quadrant")
      .data(x.quadrants)
      .enter()
      .append("g")
      .attr("class", "quadrant");
    ...
    const ut = G.selectAll("g.data-point")
      .data(x.points)
      .enter()
      .append("g")
