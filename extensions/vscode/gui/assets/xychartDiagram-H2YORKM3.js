...
function Ri(e, t, i) {
  ...
  for (
    var s = -1, n = Math.max(0, Math.ceil((t - e) / i)) | 0, r = new Array(n);
    ++s < n;
  )
    r[s] = e + s * i;
  return r;
...
var bt = (function () {
  var e = a(function (F, h, u, x) {
    ...
    $ = {
      ...
      performAction: a(function (h, u, x, d, w, o, at) {
        var f = o.length - 1;
        switch (w) {
          case 5:
      ...
      table: [
        e(t, i, { 3: 1, 4: 2, 7: 4, 5: s, 34: n, 35: r, 36: g }),
        { 1: [3] },
        e(t, i, { 4: 2, 7: 4, 3: 8, 5: s, 34: n, 35: r, 36: g }),
        e(t, i, {
          4: 2,
          7: 4,
          6: 9,
        ...
        e(m, [2, 36]),
        { 1: [2, 1] },
        e(t, i, { 4: 2, 7: 4, 3: 21, 5: s, 34: n, 35: r, 36: g }),
        { 1: [2, 3] },
        e(m, [2, 5]),
        e(t, [2, 7], { 4: 22, 34: n, 35: r, 36: g }),
        {
          11: 23,
          37: 24,
          38: p,
            ...
            case 2:
              if (
                ...
                (pt = this.performAction.apply(
                  q,
                  [f, It, lt, Y.yy, B[1], w, o].concat(li),
                )),
                typeof pt < "u")
              )
                return pt;
        ...
        unput: a(function (h) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: x
                ? (x.length === d.length ? this.yylloc.first_column : 0) +
                  d[d.length - x.length].length -
                  x[0].length
...
` +
        ...
        test_match: a(function (h, u) {
          ...
          if (
            (this.options.backtrack_lexer &&
              ...
              this.options.ranges &&
                (w.yylloc.range = this.yylloc.range.slice(0))),
            (d = h[0].match(/(?:\r\n?|\n).*/g)),
        ...
        next: a(function () {
          ...
          for (var w = this._currentRules(), o = 0; o < w.length; o++)
            if (
              ((x = this._input.match(this.rules[w[o]])),
              x && (!u || x[0].length > u[0].length))
            ) {
              if (((u = x), (d = o), this.options.backtrack_lexer)) {
                if (((h = this.test_match(x, w[o])), h !== !1)) return h;
                if (this._backtrack) {
                  u = !1;
                  devconx;
                } else return !1;
...
` +
        ...
        topState: a(function (u) {
          return (
            ...
            u >= 0 ? this.conditionStack[u] : "INITIAL"
          );
        }, "topState"),
  ...
  vi =
    ((Z = class extends Ut {
      constructor(t, i, s, n, r) {
        (super(t, n, r, i),
          (this.domain = s),
          (this.scale = zt().domain(this.domain).range(this.getRange())));
      }
      getTickValues() {
      ...
      recalculateScale() {
        ...
        (this.axisPosition === "left" && t.reverse(),
          (this.scale = zt().domain(t).range(this.getRange())));
      }
      getScaleValue(t) {
        return this.scale(t);
      }
...
function wt(e, t, i, s) {
  const n = new Ht(s);
  return _t(e)
    ? new Di(t, i, e.categories, e.title, n)
    : new vi(t, i, [e.min, e.max], e.title, n);
}
a(wt, "getAxis");
var J,
  Pi =
    ...
    ((st = class {
      ...
      calculateVerticalSpace() {
        let t = this.chartConfig.width,
          ...
          s = 0,
          n = 0,
          r = Math.floor((t * this.chartConfig.plotReservedSpacePercent) / 100),
          g = Math.floor((i * this.chartConfig.plotReservedSpacePercent) / 100),
          m = this.componentStore.plot.calculateSpace({ width: r, height: g });
        ((t -= m.width),
          (i -= m.height),
          (m = this.componentStore.title.calculateSpace({
          ...
          (m = this.componentStore.xAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (i -= m.height),
          this.componentStore.yAxis.setAxisPosition("left"),
          (m = this.componentStore.yAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (s = m.width),
          ...
          t > 0 && ((r += t), (t = 0)),
          i > 0 && ((g += i), (i = 0)),
          this.componentStore.plot.calculateSpace({ width: r, height: g }),
          this.componentStore.plot.setBoundingBoxXY({ x: s, y: n }),
          this.componentStore.xAxis.setRange([s, s + r]),
          ...
          this.chartData.plots.some((p) => At(p)) &&
      ...
      calculateHorizontalSpace() {
        ...
        ((t -= p.width),
          (i -= p.height),
          (p = this.componentStore.title.calculateSpace({
            width: this.chartConfig.width,
            height: i,
          })),
          (s = p.height),
          ...
          (p = this.componentStore.xAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (t -= p.width),
          ...
          (p = this.componentStore.yAxis.calculateSpace({
            width: t,
            height: i,
          })),
          (i -= p.height),
          ...
          this.componentStore.xAxis.setRange([r, r + m]),
          this.componentStore.xAxis.setBoundingBoxXY({ x: 0, y: r }),
          this.chartData.plots.some((k) => At(k)) &&
            this.componentStore.xAxis.recalculateOuterPaddingToDrawBar());
      }
      calculateSpace() {
...
function Qt(e) {
  e === "horizontal"
    ? (rt.chartOrientation = "horizontal")
    : (rt.chartOrientation = "vertical");
}
a(Qt, "setOrientation");
function Kt(e) {
...
function Pt(e) {
  ...
  if (
    (kt || ii(e),
    _t(A.xAxis) && (t = A.xAxis.categories.map((i, s) => [i, e[s]])),
    G(A.xAxis))
  ) {
    const i = A.xAxis.min,
      s = A.xAxis.max,
...
function ei(e, t) {
  const i = Pt(t);
  (A.plots.push({ type: "line", strokeFill: Lt(ot), strokeWidth: 2, data: i }),
    ot++);
}
a(ei, "setLineData");
function si(e, t) {
  const i = Pt(t);
  (A.plots.push({ type: "bar", fill: Lt(ot), data: i }), ot++);
}
a(si, "setBarData");
function ni() {
  if (A.plots.length === 0)
    ...
    function I(y) {
      ...
      for (const [W] of y.entries()) {
        ...
        (W > 0 && P[c] && (z = P[c]),
          (c += y[W]),
          (_ = P[c]),
          _ || (_ = P[c] = z.append("g").attr("class", y[W])));
      }
      return _;
    }
    a(I, "getGroup");
    for (const y of D) {
      if (y.data.length === 0) devconx;
